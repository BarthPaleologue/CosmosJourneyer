...
"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["482"],{11046:function(e,r,a){a.r(r),a.d(r,{bumpFragmentMainFunctionsWGSL:()=>t});var i=a(66755);let f="bumpFragmentMainFunctions",n=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n);let t={name:f,shader:n}},14482:function(e,r,a){var i=a(66755);let f="harmonicsFunctions",n=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n)},25513:function(e,r,a){var i=a(66755);let f="subSurfaceScatteringFunctions",n=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n)},33109:function(e,r,a){var i=a(66755);let f="oitFragment",n=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n)},36538:function(e,r,a){a.r(r),a.d(r,{pbrPixelShaderWGSL:()=>em});var i=a(66755);a(447),a(99299),a(55300),a(65625);let f="pbrFragmentExtraDeclaration",n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n),a(58087),a(9718);let t="samplerFragmentAlternateDeclaration",o=`#ifdef _DEFINENAME_
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[t]||(i.v.IncludesShadersStoreWGSL[t]=o);let c="pbrFragmentSamplersDeclaration",l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;i.v.IncludesShadersStoreWGSL[c]||(i.v.IncludesShadersStoreWGSL[c]=l),a(35962),a(87889),a(33083),a(22526),a(85116),a(25513),a(58266);let d="pbrHelperFunctions",s=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;i.v.IncludesShadersStoreWGSL[d]||(i.v.IncludesShadersStoreWGSL[d]=s),a(82321),a(61340),a(14482),a(35437);let v="pbrDirectLightingSetupFunctions",E=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;i.v.IncludesShadersStoreWGSL[v]||(i.v.IncludesShadersStoreWGSL[v]=E);let m="pbrDirectLightingFalloffFunctions",u=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;i.v.IncludesShadersStoreWGSL[m]||(i.v.IncludesShadersStoreWGSL[m]=u),a(67308),a(92367);let S="pbrDirectLightingFunctions",R=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
#endif
`;i.v.IncludesShadersStoreWGSL[S]||(i.v.IncludesShadersStoreWGSL[S]=R);let p="pbrIBLFunctions",C=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;i.v.IncludesShadersStoreWGSL[p]||(i.v.IncludesShadersStoreWGSL[p]=C),a(11046),a(52547),a(72494),a(58311);let A="pbrBlockAlbedoOpacity",I=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;i.v.IncludesShadersStoreWGSL[A]||(i.v.IncludesShadersStoreWGSL[A]=I);let N="pbrBlockReflectivity",L=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
`;i.v.IncludesShadersStoreWGSL[N]||(i.v.IncludesShadersStoreWGSL[N]=L);let O="pbrBlockAmbientOcclusion",T=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;i.v.IncludesShadersStoreWGSL[O]||(i.v.IncludesShadersStoreWGSL[O]=T);let _="pbrBlockAlphaFresnel",h=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[_]||(i.v.IncludesShadersStoreWGSL[_]=h);let g="pbrBlockAnisotropic",D=`#ifdef ANISOTROPIC
...
#endif
`;i.v.IncludesShadersStoreWGSL[g]||(i.v.IncludesShadersStoreWGSL[g]=D);let M="pbrBlockReflection",F=`#ifdef REFLECTION
...
#endif
`;i.v.IncludesShadersStoreWGSL[M]||(i.v.IncludesShadersStoreWGSL[M]=F);let P="pbrBlockSheen",b=`#ifdef SHEEN
...
#endif
`;i.v.IncludesShadersStoreWGSL[P]||(i.v.IncludesShadersStoreWGSL[P]=b);let U="pbrBlockClearcoat",B=`struct clearcoatOutParams
...
return outParams;}
#endif
`;i.v.IncludesShadersStoreWGSL[U]||(i.v.IncludesShadersStoreWGSL[U]=B);let G="pbrBlockIridescence",y=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;i.v.IncludesShadersStoreWGSL[G]||(i.v.IncludesShadersStoreWGSL[G]=y);let x="pbrBlockSubSurface",V=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;i.v.IncludesShadersStoreWGSL[x]||(i.v.IncludesShadersStoreWGSL[x]=V),a(39220);let H="pbrBlockNormalGeometric",W=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;i.v.IncludesShadersStoreWGSL[H]||(i.v.IncludesShadersStoreWGSL[H]=W),a(52284);let X="pbrBlockNormalFinal",Y=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[X]||(i.v.IncludesShadersStoreWGSL[X]=Y),a(83529);let w="pbrBlockLightmapInit",k=`#ifdef LIGHTMAP
...
#endif
`;i.v.IncludesShadersStoreWGSL[w]||(i.v.IncludesShadersStoreWGSL[w]=k);let z="pbrBlockGeometryInfo",K=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[z]||(i.v.IncludesShadersStoreWGSL[z]=K);let q="pbrBlockReflectance0",Z=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;i.v.IncludesShadersStoreWGSL[q]||(i.v.IncludesShadersStoreWGSL[q]=Z);let J="pbrBlockReflectance",j=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[J]||(i.v.IncludesShadersStoreWGSL[J]=j);let Q="pbrBlockDirectLighting",$=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;i.v.IncludesShadersStoreWGSL[Q]||(i.v.IncludesShadersStoreWGSL[Q]=$),a(32858);let ee="pbrBlockFinalLitComponents",er=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[ee]||(i.v.IncludesShadersStoreWGSL[ee]=er);let ea="pbrBlockFinalUnlitComponents",ei=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;i.v.IncludesShadersStoreWGSL[ea]||(i.v.IncludesShadersStoreWGSL[ea]=ei);let ef="pbrBlockFinalColorComposition",en=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;i.v.IncludesShadersStoreWGSL[ef]||(i.v.IncludesShadersStoreWGSL[ef]=en),a(23203),a(41001);let et="pbrBlockImageProcessing",eo=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;i.v.IncludesShadersStoreWGSL[et]||(i.v.IncludesShadersStoreWGSL[et]=eo);let ec="pbrBlockPrePass",el=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;i.v.IncludesShadersStoreWGSL[ec]||(i.v.IncludesShadersStoreWGSL[ec]=el),a(33109);let ed="pbrDebug",es=`#if DEBUGMODE>0
...
#endif
`;i.v.IncludesShadersStoreWGSL[ed]||(i.v.IncludesShadersStoreWGSL[ed]=es);let ev="pbrPixelShader",eE=`#define PBR_FRAGMENT_SHADER
...
`;i.v.ShadersStoreWGSL[ev]||(i.v.ShadersStoreWGSL[ev]=eE);let em={name:ev,shader:eE}},447:function(e,r,a){var i=a(66755);let f="prePassDeclaration",n=`#ifdef PREPASS
#ifdef PREPASS_LOCAL_POSITION
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n)},52284:function(e,r,a){a.r(r),a.d(r,{bumpFragmentWGSL:()=>t});var i=a(66755);let f="bumpFragment",n=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n);let t={name:f,shader:n}},52547:function(e,r,a){a.r(r),a.d(r,{bumpFragmentFunctionsWGSL:()=>t});var i=a(66755);a(9718);let f="bumpFragmentFunctions",n=`#if defined(BUMP)
...
#endif
#endif 
`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n)},83529:function(e,r,a){var i=a(66755);let f="depthPrePass",n=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n)},92367:function(e,r,a){var i=a(66755);let f="hdrFilteringFunctions",n=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n)},9718:function(e,r,a){var i=a(66755);let f="samplerFragmentDeclaration",n=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n)},99299:function(e,r,a){var i=a(66755);let f="oitDeclaration",n=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;i.v.IncludesShadersStoreWGSL[f]||(i.v.IncludesShadersStoreWGSL[f]=n)}}]);