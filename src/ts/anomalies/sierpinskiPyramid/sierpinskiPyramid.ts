...
export class SierpinskiPyramid implements CelestialBody, Cullable {
    readonly model: SierpinskiPyramidModel;
     ...
     * @param scene
     */
    constructor(model: SierpinskiPyramidModel, scene: Scene) {
        this.model = model;
