...
export class StarSystemController {
    ...
    public dispose() {
        ...
        this.satellites.forEach((satellite) => satellite.dispose(this.assets.textures.pools.ringsLut));
        this.planets.forEach((planet) => planet.dispose(this.assets.textures.pools.ringsLut));
