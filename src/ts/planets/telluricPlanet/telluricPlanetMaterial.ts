...
import { TelluricPlanetMaterialLutPool } from "../../assets/texturePools/telluricPlanetMaterialLutPool";
...
export class TelluricPlanetMaterial extends ShaderMaterial {
    ...
    constructor(
        ...
        texturePool: TelluricPlanetMaterialLutPool,
        scene: Scene
    ) {
        ...
        const lut = texturePool.getTelluricPlanetMaterialLut(scene);
        ...
        this.onDisposeObservable.addOnce(() => {
            texturePool.returnTelluricPlanetMaterialLut(lut);
            emptyTexture.dispose();
        });
