...
export async function loadMercuryAlbedo(scene: Scene) {
    return createTextureAsync(mercuryColorMap, scene);
}

export async function loadMercuryNormal(scene: Scene) {
    return createTextureAsync(mercuryNormalMap, scene);
}
