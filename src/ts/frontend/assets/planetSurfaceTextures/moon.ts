...
export async function loadMoonAlbedo(scene: Scene): Promise<Texture> {
    return createTextureAsync(moonAlbedoPath, scene);
}

export async function loadMoonNormal(scene: Scene): Promise<Texture> {
    return createTextureAsync(moonNormalPath, scene);
}
