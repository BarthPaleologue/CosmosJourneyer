...
export class Spaceship implements Transformable {
    ...
    public static async New(
        ...
        const enableWarpDriveSound = await soundPlayer.createInstance(
        ...
        const disableWarpDriveSound = await soundPlayer.createInstance(
        ...
        const acceleratingWarpDriveSound = await soundPlayer.createInstance(
        ...
        const deceleratingWarpDriveSound = await soundPlayer.createInstance(
        ...
        const hyperSpaceSound = await soundPlayer.createInstance(
            SoundType.HYPER_SPACE,
            AudioMasks.HYPER_SPACE,
            0,
            false,
        );

        const thrusterSound = await soundPlayer.createInstance(
            SoundType.THRUSTER,
            AudioMasks.STAR_SYSTEM_VIEW,
            0,
            false,
