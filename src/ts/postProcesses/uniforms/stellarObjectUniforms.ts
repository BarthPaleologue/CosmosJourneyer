...
export function setStellarObjectUniforms(effect: Effect, stellarObjects: Transformable[]): void {
    ...
    effect.setArray3(
        ...
        flattenColor3Array(stellarObjects.map((stellarObject) => (stellarObject instanceof Star ? getRgbFromTemperature(stellarObject.model.physicalProperties.temperature) : Color3.White())))
    );
}
