...
export class StarSystemHelper {
  ...
  public static makeSatellite(starsystem: StarSystem, planet: Planemo, model: TelluricPlanemoModel | number = getMoonSeed(planet.model, planet.model.childrenBodies.length)): TelluricPlanemo {
