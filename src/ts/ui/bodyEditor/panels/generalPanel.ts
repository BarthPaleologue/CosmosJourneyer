...
export class GeneralPanel extends EditorPanel {
    ...
    init(body: Transformable & HasBoundingSphere, colorCorrection: ColorCorrection, bloom: BloomEffect, scene: Scene) {
        ...
        this.sliders = [
            new Slider(
                "axialTiltX",
                document.getElementById("axialTiltX") as HTMLElement,
                -180,
                180,
                Math.round(Tools.ToDegrees(axialTilt.x)),
                (val: number) => {
            ...
            new Slider(
                "axialTiltZ",
                document.getElementById("axialTiltZ") as HTMLElement,
                -180,
                180,
                Math.round(Tools.ToDegrees(axialTilt.z)),
                (val: number) => {
                    const newAxialTilt = Tools.ToRadians(val);
            ...
            new Slider(
                "timeModifier",
                document.getElementById("timeModifier") as HTMLElement,
                -200,
                400,
                Math.pow(Settings.TIME_MULTIPLIER, 1 / power),
                (val: number) => {
            ...
            new Slider(
                "exposure",
                document.getElementById("exposure") as HTMLElement,
                0,
                200,
                colorCorrection.exposure * 100,
                (val: number) => {
            ...
            new Slider(
                "contrast",
                document.getElementById("contrast") as HTMLElement,
                0,
                200,
            ...
            new Slider(
                "brightness",
                document.getElementById("brightness") as HTMLElement,
                -100,
                100,
                colorCorrection.brightness * 100,
                (val: number) => {
            ...
            new Slider(
                "saturation",
                document.getElementById("saturation") as HTMLElement,
                0,
                200,
                colorCorrection.saturation * 100,
                (val: number) => {
            ...
            new Slider(
                "gamma",
                document.getElementById("gamma") as HTMLElement,
                0,
                300,
                colorCorrection.gamma * 100,
                (val: number) => {
            ...
            new Slider(
                "bloomThreshold",
                document.getElementById("bloomThreshold") as HTMLElement,
                0,
                100,
                bloom.threshold * 100,
                (val: number) => {
            ...
            new Slider(
                "bloomWeight",
                document.getElementById("bloomWeight") as HTMLElement,
                0,
                600,
                bloom.weight * 100,
                (val: number) => {
            ...
            new Slider(
                "bloomKernel",
                document.getElementById("bloomKernel") as HTMLElement,
                0,
                100,
                bloom.kernel,
                (val: number) => {
