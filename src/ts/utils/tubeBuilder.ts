import { TmpVectors, Vector3, Vector4 } from "@babylonjs/core/Maths/math.vector";
import { CreateRibbon, Mesh } from "@babylonjs/core/Meshes";
import { Nullable } from "@babylonjs/core/types";
import { Path3D, Scene } from "@babylonjs/core";
    ...
    const tubePathArray = (
        ...
        for (let i = 0; i < path.length; i++) {
            ...
            for (let t = 0; t < tessellation; t++) {
                Matrix.RotationAxisToRef(tangents[i], Math.PI / tessellation + step * t, rotationMatrix);
