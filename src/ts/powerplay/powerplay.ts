...
export const MaterialistSpiritalistAxis = (x: number, y: number, z: number) => (materialistSpiritalistPerlin(x * 0.5, y * 0.5, z * 0.5)) * 0.5 + 0.5;
...
export const CapitalistCommunistAxis = (x: number, y: number, z: number) => (capitalistCommunistPerlin(x * 0.5, y * 0.5, z * 0.5)) * 0.5 + 0.5;
