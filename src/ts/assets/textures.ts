...
export async function loadTextures(
    ...
    const spaceStationMetallicPromise = loadTextureAsync("SpaceStationMetallic", spaceStationMetallic);
    const spaceStationRoughnessPromise = loadTextureAsync("SpaceStationRoughness", spaceStationRoughness);
    ...
    const metalPanelsMetallicPromise = loadTextureAsync("MetalPanelsMetallic", metalPanelsMetallic);
    const metalPanelsRoughnessPromise = loadTextureAsync("MetalPanelsRoughness", metalPanelsRoughness);
    ...
    return {
        ...
        materials: {
            ...
            spaceStation: {
                ...
                metallic: await spaceStationMetallicPromise,
                roughness: await spaceStationRoughnessPromise,
            ...
            metalPanels: {
                ...
                metallic: await metalPanelsMetallicPromise,
                roughness: await metalPanelsRoughnessPromise,
