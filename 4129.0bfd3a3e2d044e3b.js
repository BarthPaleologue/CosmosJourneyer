"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["4129"],{17269:function(e,t,o){var a=o(66755);let n="hdrFilteringFunctions",i=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;a.v.IncludesShadersStore[n]||(a.v.IncludesShadersStore[n]=i)},90620:function(e,t,o){o.r(t),o.d(t,{hdrIrradianceFilteringPixelShader:()=>f});var a=o(66755);o(95277),o(62918),o(2339),o(17269);let n="hdrIrradianceFilteringPixelShader",i=`#include<helperFunctions>
...
,icdfTexture
#endif
);gl_FragColor=vec4(color*hdrScale,1.0);}`;a.v.ShadersStore[n]||(a.v.ShadersStore[n]=i);let f={name:n,shader:i}}}]);