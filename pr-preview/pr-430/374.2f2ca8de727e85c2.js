"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["374"],{57985:function(e,r,a){a.r(r),a.d(r,{vrDistortionCorrectionPixelShader:()=>n});var t=a(80709);let o="vrDistortionCorrectionPixelShader",c=`varying vec2 vUV;uniform sampler2D textureSampler;uniform vec2 LensCenter;uniform vec2 Scale;uniform vec2 ScaleIn;uniform vec4 HmdWarpParam;vec2 HmdWarp(vec2 in01) {vec2 theta=(in01-LensCenter)*ScaleIn; 
