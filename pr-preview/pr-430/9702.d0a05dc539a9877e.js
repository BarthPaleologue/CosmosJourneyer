"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["9702"],{98859:function(e,t,a){var o=a(80709);let n="hdrFilteringFunctions",i=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;o.v.IncludesShadersStore[n]||(o.v.IncludesShadersStore[n]=i)},37590:function(e,t,a){var o=a(80709);let n="importanceSampling",i=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;o.v.IncludesShadersStore[n]||(o.v.IncludesShadersStore[n]=i)},18936:function(e,t,a){var o=a(80709);let n="pbrBRDFFunctions",i=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;o.v.IncludesShadersStore[n]||(o.v.IncludesShadersStore[n]=i)},52003:function(e,t,a){a.r(t),a.d(t,{hdrIrradianceFilteringPixelShader:()=>r});var o=a(80709);a(81949),a(37590),a(18936),a(98859);let n="hdrIrradianceFilteringPixelShader",i=`#include<helperFunctions>
...
,icdfTexture
#endif
);gl_FragColor=vec4(color*hdrScale,1.0);}`;o.v.ShadersStore[n]||(o.v.ShadersStore[n]=i);let r={name:n,shader:i}}}]);