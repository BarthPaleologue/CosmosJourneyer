"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["8314"],{97567:function(e,o,i){i.r(o),i.d(o,{imageProcessingDeclaration:()=>s});var t=i(80709);let a="imageProcessingDeclaration",r=`#ifdef EXPOSURE
...
#endif
`;t.v.IncludesShadersStore[a]||(t.v.IncludesShadersStore[a]=r);let s={name:a,shader:r}},87996:function(e,o,i){i.r(o),i.d(o,{imageProcessingFunctions:()=>s});var t=i(80709);let a="imageProcessingFunctions",r=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;t.v.IncludesShadersStore[a]||(t.v.IncludesShadersStore[a]=r);let s={name:a,shader:r}},79370:function(e,o,i){i.r(o),i.d(o,{lightFragment:()=>s});var t=i(80709);let a="lightFragment",r=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.v.IncludesShadersStore[a]||(t.v.IncludesShadersStore[a]=r);let s={name:a,shader:r}},55827:function(e,o,i){i.r(o),i.d(o,{lightFragmentDeclaration:()=>s});var t=i(80709);let a="lightFragmentDeclaration",r=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.v.IncludesShadersStore[a]||(t.v.IncludesShadersStore[a]=r);let s={name:a,shader:r}},36092:function(e,o,i){i.r(o),i.d(o,{lightUboDeclaration:()=>s});var t=i(80709);let a="lightUboDeclaration",r=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;t.v.IncludesShadersStore[a]||(t.v.IncludesShadersStore[a]=r)},62934:function(e,o,i){i.r(o),i.d(o,{reflectionFunction:()=>s});var t=i(80709);let a="reflectionFunction",r=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;t.v.IncludesShadersStore[a]||(t.v.IncludesShadersStore[a]=r);let s={name:a,shader:r}},40522:function(e,o,i){i.r(o),i.d(o,{shadowsFragmentFunctions:()=>s});var t=i(80709);let a="shadowsFragmentFunctions",r=`#ifdef SHADOWS
...
#endif
#endif
`;t.v.IncludesShadersStore[a]||(t.v.IncludesShadersStore[a]=r);let s={name:a,shader:r}}}]);