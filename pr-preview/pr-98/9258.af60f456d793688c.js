"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["9258"],{9885:function(e,r,f){f.r(r),f.d(r,{iblCdfDebugPixelShaderWGSL:()=>u});var c=f(80709);let t="iblCdfDebugPixelShader",i=`#define PI 3.1415927
...
fragmentOutputs.color =vec4(mix(colour,backgroundColour,0.5),1.0);}`;c.v.ShadersStoreWGSL[t]||(c.v.ShadersStoreWGSL[t]=i);let u={name:t,shader:i}}}]);