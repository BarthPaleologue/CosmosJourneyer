"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["7858"],{84654:function(e,i,n){n.r(i),n.d(i,{bumpFragment:()=>o});var a=n(80709);let r="bumpFragment",t=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t);let o={name:r,shader:t}},86377:function(e,i,n){n.r(i),n.d(i,{bumpFragmentFunctions:()=>o});var a=n(80709);n(8059);let r="bumpFragmentFunctions",t=`#if defined(BUMP)
...
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t);let o={name:r,shader:t}},97298:function(e,i,n){n.r(i),n.d(i,{bumpFragmentMainFunctions:()=>o});var a=n(80709);let r="bumpFragmentMainFunctions",t=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#ifdef OBJECTSPACE_NORMALMAP
...
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t);let o={name:r,shader:t}},33596:function(e,i,n){var a=n(80709);let r="decalFragment",t=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},19932:function(e,i,n){var a=n(80709);let r="decalFragmentDeclaration",t=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},85559:function(e,i,n){var a=n(80709);let r="depthPrePass",t=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},29903:function(e,i,n){var a=n(80709);let r="harmonicsFunctions",t=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},98859:function(e,i,n){var a=n(80709);let r="hdrFilteringFunctions",t=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},37590:function(e,i,n){var a=n(80709);let r="importanceSampling",t=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},9609:function(e,i,n){var a=n(80709);let r="mainUVVaryingDeclaration",t=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},52459:function(e,i,n){var a=n(80709);let r="oitDeclaration",t=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},34831:function(e,i,n){var a=n(80709);let r="oitFragment",t=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},18936:function(e,i,n){var a=n(80709);let r="pbrBRDFFunctions",t=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},8059:function(e,i,n){var a=n(80709);let r="samplerFragmentDeclaration",t=`#ifdef _DEFINENAME_
...
#endif
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},37332:function(e,i,n){var a=n(80709);let r="subSurfaceScatteringFunctions",t=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t)},21040:function(e,i,n){n.r(i),n.d(i,{pbrPixelShader:()=>em});var a=n(80709);n(94046),n(52459),n(19932);let r="pbrFragmentDeclaration",t=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;a.v.IncludesShadersStore[r]||(a.v.IncludesShadersStore[r]=t),n(22411),n(9609);let o="pbrFragmentExtraDeclaration",f=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;a.v.IncludesShadersStore[o]||(a.v.IncludesShadersStore[o]=f),n(55827),n(36092),n(8059);let l="samplerFragmentAlternateDeclaration",c=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
`;a.v.IncludesShadersStore[d]||(a.v.IncludesShadersStore[d]=s),n(97567),n(78471),n(83022),n(89449),n(81949),n(37332),n(37590);let E="pbrHelperFunctions",R=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;a.v.IncludesShadersStore[E]||(a.v.IncludesShadersStore[E]=R),n(87996),n(40522),n(29903),n(1111);let v="pbrDirectLightingSetupFunctions",u=`struct preLightingInfo
...
#endif
`;a.v.IncludesShadersStore[v]||(a.v.IncludesShadersStore[v]=u);let m="pbrDirectLightingFalloffFunctions",C=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;a.v.IncludesShadersStore[m]||(a.v.IncludesShadersStore[m]=C),n(18936),n(98859);let S="pbrDirectLightingFunctions",A=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SS_TRANSLUCENCY
...
#endif
`;a.v.IncludesShadersStore[I]||(a.v.IncludesShadersStore[I]=N),n(97298),n(86377),n(62934),n(33596);let p="pbrBlockAlbedoOpacity",T=`struct albedoOpacityOutParams
...
`;a.v.IncludesShadersStore[p]||(a.v.IncludesShadersStore[p]=T);let O="pbrBlockReflectivity",L=`struct reflectivityOutParams
...
`;a.v.IncludesShadersStore[O]||(a.v.IncludesShadersStore[O]=L);let g="pbrBlockAmbientOcclusion",h=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;a.v.IncludesShadersStore[g]||(a.v.IncludesShadersStore[g]=h);let _="pbrBlockAlphaFresnel",D=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;a.v.IncludesShadersStore[_]||(a.v.IncludesShadersStore[_]=D);let M="pbrBlockAnisotropic",F=`#ifdef ANISOTROPIC
...
return outParams;}
#endif
`;a.v.IncludesShadersStore[H]||(a.v.IncludesShadersStore[H]=W),n(40666);let X="pbrBlockNormalGeometric",Y=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;a.v.IncludesShadersStore[X]||(a.v.IncludesShadersStore[X]=Y),n(84654);let k="pbrBlockNormalFinal",w=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;a.v.IncludesShadersStore[k]||(a.v.IncludesShadersStore[k]=w),n(85559);let z="pbrBlockLightmapInit",q=`#ifdef LIGHTMAP
...
#endif
#endif
`;a.v.IncludesShadersStore[K]||(a.v.IncludesShadersStore[K]=Z);let J="pbrBlockReflectance0",j=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;a.v.IncludesShadersStore[ee]||(a.v.IncludesShadersStore[ee]=ei),n(79370);let en="pbrBlockFinalLitComponents",ea=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;a.v.IncludesShadersStore[en]||(a.v.IncludesShadersStore[en]=ea);let er="pbrBlockFinalUnlitComponents",et=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;a.v.IncludesShadersStore[er]||(a.v.IncludesShadersStore[er]=et);let eo="pbrBlockFinalColorComposition",ef=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;a.v.IncludesShadersStore[eo]||(a.v.IncludesShadersStore[eo]=ef),n(52813),n(88307);let el="pbrBlockImageProcessing",ec=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
#endif
`;a.v.IncludesShadersStore[ed]||(a.v.IncludesShadersStore[ed]=es),n(34831);let eE="pbrDebug",eR=`#if DEBUGMODE>0
...
#endif
`;a.v.IncludesShadersStore[eE]||(a.v.IncludesShadersStore[eE]=eR);let ev="pbrPixelShader",eu=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;a.v.ShadersStore[ev]||(a.v.ShadersStore[ev]=eu);let em={name:ev,shader:eu}}}]);