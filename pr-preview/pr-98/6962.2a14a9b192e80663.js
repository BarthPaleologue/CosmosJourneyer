"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["6962"],{88776:function(e,t,r){r.r(t),r.d(t,{imageProcessingDeclarationWGSL:()=>f});var o=r(80709);let i="imageProcessingDeclaration",a=`#ifdef EXPOSURE
...
#endif
`;o.v.IncludesShadersStoreWGSL[i]||(o.v.IncludesShadersStoreWGSL[i]=a);let f={name:i,shader:a}},40203:function(e,t,r){r.r(t),r.d(t,{imageProcessingFunctionsWGSL:()=>f});var o=r(80709);let i="imageProcessingFunctions",a=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;o.v.IncludesShadersStoreWGSL[i]||(o.v.IncludesShadersStoreWGSL[i]=a);let f={name:i,shader:a}},2352:function(e,t,r){r.r(t),r.d(t,{lightFragmentWGSL:()=>f});var o=r(80709);let i="lightFragment",a=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.v.IncludesShadersStoreWGSL[i]||(o.v.IncludesShadersStoreWGSL[i]=a);let f={name:i,shader:a}},89083:function(e,t,r){r.r(t),r.d(t,{lightUboDeclarationWGSL:()=>f});var o=r(80709);let i="lightUboDeclaration",a=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
vec3f( 0,1,0 ),
vec3f( 0,0,1 )
);result.Diffuse+=LTCEvaluate( normal,viewDir,position,mInvEmpty,rectCoords0,rectCoords1,rectCoords2,rectCoords3 );return result;}`;o.v.IncludesShadersStoreWGSL[i]||(o.v.IncludesShadersStoreWGSL[i]=a)},48396:function(e,t,r){r.r(t),r.d(t,{reflectionFunctionWGSL:()=>f});var o=r(80709);let i="reflectionFunction",a=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;o.v.IncludesShadersStoreWGSL[i]||(o.v.IncludesShadersStoreWGSL[i]=a);let f={name:i,shader:a}},69191:function(e,t,r){r.r(t),r.d(t,{shadowsFragmentFunctionsWGSL:()=>f});var o=r(80709);let i="shadowsFragmentFunctions",a=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;o.v.IncludesShadersStoreWGSL[i]||(o.v.IncludesShadersStoreWGSL[i]=a);let f={name:i,shader:a}}}]);