"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["4646"],{8516:function(e,o,i){var r=i(80709);i(1687);let t="backgroundUboDeclaration",n=`layout(std140,column_major) uniform;uniform Material
...
`;r.v.IncludesShadersStore[t]||(r.v.IncludesShadersStore[t]=n)},16896:function(e,o,i){i.r(o),i.d(o,{lightsFragmentFunctions:()=>l});var r=i(80709);i(1111);let t="lightsFragmentFunctions",n=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;r.v.IncludesShadersStore[t]||(r.v.IncludesShadersStore[t]=n);let l={name:t,shader:n}},93198:function(e,o,i){i.r(o),i.d(o,{backgroundPixelShader:()=>s});var r=i(80709);let t="backgroundFragmentDeclaration",n=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
uniform vec2 projectedGroundInfos;
#endif
`;r.v.IncludesShadersStore[t]||(r.v.IncludesShadersStore[t]=n),i(8516),i(81949),i(62934),i(97567),i(55827),i(36092),i(16896),i(40522),i(87996),i(83022),i(78471),i(89449);let l="intersectionFunctions",f=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;r.v.IncludesShadersStore[l]||(r.v.IncludesShadersStore[l]=f),i(40666),i(79370),i(52813),i(88307);let c="backgroundPixelShader",a=`#ifdef TEXTURELODSUPPORT
...
`;r.v.ShadersStore[c]||(r.v.ShadersStore[c]=a);let s={name:c,shader:a}}}]);