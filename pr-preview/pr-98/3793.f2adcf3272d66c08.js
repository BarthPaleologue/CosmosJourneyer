...
"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["3793"],{88099:function(e,r,a){a.r(r),a.d(r,{bumpFragmentWGSL:()=>t});var i=a(80709);let n="bumpFragment",f=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},96988:function(e,r,a){a.r(r),a.d(r,{bumpFragmentFunctionsWGSL:()=>t});var i=a(80709);a(88037);let n="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},4061:function(e,r,a){a.r(r),a.d(r,{bumpFragmentMainFunctionsWGSL:()=>t});var i=a(80709);let n="bumpFragmentMainFunctions",f=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
...
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},39508:function(e,r,a){var i=a(80709);let n="depthPrePass",f=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f)},18548:function(e,r,a){var i=a(80709);let n="harmonicsFunctions",f=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f)},65945:function(e,r,a){var i=a(80709);let n="hdrFilteringFunctions",f=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f)},15030:function(e,r,a){var i=a(80709);let n="importanceSampling",f=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDggx(u: vec2f,a: f32)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDCharlie(u: vec2f,a: f32)->vec3f { 
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f)},99557:function(e,r,a){var i=a(80709);let n="mainUVVaryingDeclaration",f=`#ifdef MAINUV{X}
varying vMainUV{X}: vec2f;
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f)},90279:function(e,r,a){var i=a(80709);let n="oitDeclaration",f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f)},43410:function(e,r,a){var i=a(80709);let n="oitFragment",f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f)},90068:function(e,r,a){var i=a(80709);let n="pbrBRDFFunctions",f=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f)},88037:function(e,r,a){var i=a(80709);let n="samplerFragmentDeclaration",f=`#ifdef _DEFINENAME_
...
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f)},56826:function(e,r,a){var i=a(80709);let n="subSurfaceScatteringFunctions",f=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f)},54830:function(e,r,a){a.r(r),a.d(r,{pbrPixelShaderWGSL:()=>em});var i=a(80709);a(20180),a(90279),a(7662),a(99557);let n="pbrFragmentExtraDeclaration",f=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;i.v.IncludesShadersStoreWGSL[n]||(i.v.IncludesShadersStoreWGSL[n]=f),a(89083),a(88037);let t="samplerFragmentAlternateDeclaration",o=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
`;i.v.IncludesShadersStoreWGSL[c]||(i.v.IncludesShadersStoreWGSL[c]=l),a(88776),a(96986),a(18832),a(25930),a(14346),a(56826),a(15030);let d="pbrHelperFunctions",s=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;i.v.IncludesShadersStoreWGSL[d]||(i.v.IncludesShadersStoreWGSL[d]=s),a(40203),a(69191),a(18548),a(96269);let v="pbrDirectLightingSetupFunctions",E=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
}`;i.v.IncludesShadersStoreWGSL[m]||(i.v.IncludesShadersStoreWGSL[m]=u),a(90068),a(65945);let S="pbrDirectLightingFunctions",p=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SS_TRANSLUCENCY
...
#endif
`;i.v.IncludesShadersStoreWGSL[S]||(i.v.IncludesShadersStoreWGSL[S]=p);let R="pbrIBLFunctions",C=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;i.v.IncludesShadersStoreWGSL[R]||(i.v.IncludesShadersStoreWGSL[R]=C),a(4061),a(96988),a(48396),a(83458);let A="pbrBlockAlbedoOpacity",I=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;i.v.IncludesShadersStoreWGSL[A]||(i.v.IncludesShadersStoreWGSL[A]=I);let N="pbrBlockReflectivity",T=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;i.v.IncludesShadersStoreWGSL[N]||(i.v.IncludesShadersStoreWGSL[N]=T);let L="pbrBlockAmbientOcclusion",O=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;i.v.IncludesShadersStoreWGSL[L]||(i.v.IncludesShadersStoreWGSL[L]=O);let h="pbrBlockAlphaFresnel",g=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[h]||(i.v.IncludesShadersStoreWGSL[h]=g);let M="pbrBlockAnisotropic",_=`#ifdef ANISOTROPIC
...
#endif
`;i.v.IncludesShadersStoreWGSL[M]||(i.v.IncludesShadersStoreWGSL[M]=_);let D="pbrBlockReflection",F=`#ifdef REFLECTION
...
#endif
`;i.v.IncludesShadersStoreWGSL[D]||(i.v.IncludesShadersStoreWGSL[D]=F);let P="pbrBlockSheen",b=`#ifdef SHEEN
...
#endif
`;i.v.IncludesShadersStoreWGSL[P]||(i.v.IncludesShadersStoreWGSL[P]=b);let U="pbrBlockClearcoat",G=`struct clearcoatOutParams
...
return outParams;}
#endif
`;i.v.IncludesShadersStoreWGSL[U]||(i.v.IncludesShadersStoreWGSL[U]=G);let B="pbrBlockIridescence",y=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;i.v.IncludesShadersStoreWGSL[B]||(i.v.IncludesShadersStoreWGSL[B]=y);let x="pbrBlockSubSurface",V=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;i.v.IncludesShadersStoreWGSL[x]||(i.v.IncludesShadersStoreWGSL[x]=V),a(57484);let H="pbrBlockNormalGeometric",W=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;i.v.IncludesShadersStoreWGSL[H]||(i.v.IncludesShadersStoreWGSL[H]=W),a(88099);let X="pbrBlockNormalFinal",w=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL[X]||(i.v.IncludesShadersStoreWGSL[X]=w),a(39508);let k="pbrBlockLightmapInit",Y=`#ifdef LIGHTMAP
...
#endif
`;i.v.IncludesShadersStoreWGSL[k]||(i.v.IncludesShadersStoreWGSL[k]=Y);let z="pbrBlockGeometryInfo",K=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
`;i.v.IncludesShadersStoreWGSL[Q]||(i.v.IncludesShadersStoreWGSL[Q]=$),a(2352);let ee="pbrBlockFinalLitComponents",er=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
`;i.v.IncludesShadersStoreWGSL[ea]||(i.v.IncludesShadersStoreWGSL[ea]=ei);let en="pbrBlockFinalColorComposition",ef=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;i.v.IncludesShadersStoreWGSL[en]||(i.v.IncludesShadersStoreWGSL[en]=ef),a(975),a(79051);let et="pbrBlockImageProcessing",eo=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;i.v.IncludesShadersStoreWGSL[ec]||(i.v.IncludesShadersStoreWGSL[ec]=el),a(43410);let ed="pbrDebug",es=`#if DEBUGMODE>0
...
#endif
`;i.v.IncludesShadersStoreWGSL[ed]||(i.v.IncludesShadersStoreWGSL[ed]=es);let ev="pbrPixelShader",eE=`#define CUSTOM_FRAGMENT_BEGIN
...
`;i.v.ShadersStoreWGSL[ev]||(i.v.ShadersStoreWGSL[ev]=eE);let em={name:ev,shader:eE}}}]);