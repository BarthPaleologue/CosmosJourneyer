...
#endif
);fragmentOutputs.color= vec4f(color*uniforms.hdrScale,1.0);}`;a.v.ShadersStoreWGSL[t]||(a.v.ShadersStoreWGSL[t]=n);let i={name:t,shader:n}},67308:function(e,f,r){var a=r(66755);let t="pbrBRDFFunctions",n=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
