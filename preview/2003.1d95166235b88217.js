...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["2003"],{3120:function(e,t,a){var o=a(28345);let n="hdrFilteringFunctions",i=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=i)},82542:function(e,t,a){var o=a(28345);let n="pbrBRDFFunctions",i=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
