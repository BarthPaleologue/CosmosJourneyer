...
`;n.l.IncludesShadersStore[r]||(n.l.IncludesShadersStore[r]=t),o(37367),o(12685),o(47791),o(9063),o(64571);let a="openpbrFragmentSamplersDeclaration",s=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;n.l.IncludesShadersStore[a]||(n.l.IncludesShadersStore[a]=s),o(77681),o(8779),o(32654),o(47083),o(56754),o(88007),o(12228),o(34510),o(69544),o(913),o(63214),o(42124),o(42357),o(20920),o(37598),o(15221),o(56653);let l="openpbrNormalMapFragmentMainFunctions",f=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;n.l.IncludesShadersStore[l]||(n.l.IncludesShadersStore[l]=f);let c="openpbrNormalMapFragmentFunctions",d=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;n.l.IncludesShadersStore[c]||(n.l.IncludesShadersStore[c]=d),o(96554);let m="openpbrDielectricReflectance",_=`struct ReflectanceParams
...
`;n.l.IncludesShadersStore[m]||(n.l.IncludesShadersStore[m]=_);let u="openpbrConductorReflectance",g=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;n.l.IncludesShadersStore[u]||(n.l.IncludesShadersStore[u]=g);let v="openpbrAmbientOcclusionFunctions",p=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;n.l.IncludesShadersStore[v]||(n.l.IncludesShadersStore[v]=p);let I="openpbrGeometryInfo",E=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;n.l.IncludesShadersStore[I]||(n.l.IncludesShadersStore[I]=E);let R="openpbrIblFunctions",h=`#ifdef REFLECTION
...
#endif
`;n.l.IncludesShadersStore[R]||(n.l.IncludesShadersStore[R]=h),o(64023),o(49660);let S="openpbrNormalMapFragment",T=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;n.l.IncludesShadersStore[S]||(n.l.IncludesShadersStore[S]=T);let N="openpbrBlockNormalFinal",A=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;n.l.IncludesShadersStore[N]||(n.l.IncludesShadersStore[N]=A);let F="openpbrBaseLayerData",L=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;n.l.IncludesShadersStore[b]||(n.l.IncludesShadersStore[b]=C);let O="openpbrCoatLayerData",D=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;n.l.IncludesShadersStore[O]||(n.l.IncludesShadersStore[O]=D);let M="openpbrThinFilmLayerData",G=`#ifdef THIN_FILM
...
#endif
`;n.l.IncludesShadersStore[M]||(n.l.IncludesShadersStore[M]=G);let x="openpbrFuzzLayerData",P=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;n.l.IncludesShadersStore[x]||(n.l.IncludesShadersStore[x]=P);let y="openpbrAmbientOcclusionData",z=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;n.l.IncludesShadersStore[y]||(n.l.IncludesShadersStore[y]=z),o(15260);let W="openpbrBackgroundTransmission",U=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;n.l.IncludesShadersStore[W]||(n.l.IncludesShadersStore[W]=U);let X="openpbrEnvironmentLighting",B=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;n.l.IncludesShadersStore[X]||(n.l.IncludesShadersStore[X]=B);let H="openpbrDirectLightingInit",V=`#ifdef LIGHT{X}
...
#endif
#endif
`;n.l.IncludesShadersStore[H]||(n.l.IncludesShadersStore[H]=V);let w="openpbrDirectLighting",k=`#ifdef LIGHT{X}
...
#endif
`;n.l.IncludesShadersStore[w]||(n.l.IncludesShadersStore[w]=k),o(29832),o(98999),o(37970),o(53164),o(41063),o(94312);let Y="openpbrPixelShader",Z=`#define OPENPBR_FRAGMENT_SHADER
...
`;n.l.ShadersStore[Y]||(n.l.ShadersStore[Y]=Z);let q={name:Y,shader:Z}}}]);