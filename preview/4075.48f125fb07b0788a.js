...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=o),a(97001),a(41267),a(97942),a(69283),a(46282),a(78815),a(36780),a(1462),a(58240),a(14905),a(20262),a(88612),a(8765),a(41152),a(34182),a(30301),a(33349);let t="openpbrNormalMapFragmentMainFunctions",f=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;i.l.IncludesShadersStoreWGSL[l]||(i.l.IncludesShadersStoreWGSL[l]=c),a(66226);let s="openpbrDielectricReflectance",m=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
#endif
`;i.l.IncludesShadersStoreWGSL[I]||(i.l.IncludesShadersStoreWGSL[I]=S),a(92047),a(13012);let h="openpbrNormalMapFragment",E=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[R]||(i.l.IncludesShadersStoreWGSL[R]=N);let A="openpbrBaseLayerData",L=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;i.l.IncludesShadersStoreWGSL[A]||(i.l.IncludesShadersStoreWGSL[A]=L);let T="openpbrCoatLayerData",F=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;i.l.IncludesShadersStoreWGSL[T]||(i.l.IncludesShadersStoreWGSL[T]=F);let O="openpbrThinFilmLayerData",b=`#ifdef THIN_FILM
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[C]||(i.l.IncludesShadersStoreWGSL[C]=M),a(4916);let D="openpbrEnvironmentLighting",x=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[D]||(i.l.IncludesShadersStoreWGSL[D]=x);let G="openpbrDirectLightingInit",P=`#ifdef LIGHT{X}
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[G]||(i.l.IncludesShadersStoreWGSL[G]=P);let z="openpbrDirectLighting",y=`#ifdef LIGHT{X}
...
#endif
`;i.l.IncludesShadersStoreWGSL[z]||(i.l.IncludesShadersStoreWGSL[z]=y),a(67072),a(22847),a(51498),a(70740),a(34751),a(35600);let W="openpbrPixelShader",U=`#define OPENPBR_FRAGMENT_SHADER
