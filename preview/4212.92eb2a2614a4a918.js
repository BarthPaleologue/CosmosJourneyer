...
`;n.l.IncludesShadersStore[a]||(n.l.IncludesShadersStore[a]=t),i(77424),i(14678),i(37090),i(67964),i(63714);let r="openpbrFragmentSamplersDeclaration",l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;n.l.IncludesShadersStore[r]||(n.l.IncludesShadersStore[r]=l),i(94548),i(43294),i(16681),i(7826),i(94953),i(34264),i(34945),i(25543),i(97957),i(79456),i(50251),i(24151),i(47402),i(85585),i(5633),i(72760),i(41878);let f="openpbrNormalMapFragmentMainFunctions",c=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;n.l.IncludesShadersStore[s]||(n.l.IncludesShadersStore[s]=d),i(82099);let m="openpbrDielectricReflectance",u=`struct ReflectanceParams
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;n.l.IncludesShadersStore[_]||(n.l.IncludesShadersStore[_]=g);let v="openpbrBlockAmbientOcclusion",I=`struct ambientOcclusionOutParams
...
`;n.l.IncludesShadersStore[v]||(n.l.IncludesShadersStore[v]=I);let p="openpbrGeometryInfo",E=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;n.l.IncludesShadersStore[p]||(n.l.IncludesShadersStore[p]=E);let h="openpbrIblFunctions",R=`#ifdef REFLECTION
...
#endif
`;n.l.IncludesShadersStore[h]||(n.l.IncludesShadersStore[h]=R),i(62776),i(54231);let N="openpbrNormalMapFragment",A=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
#endif
`;n.l.IncludesShadersStore[S]||(n.l.IncludesShadersStore[S]=T);let F="openpbrBaseLayerData",L=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;n.l.IncludesShadersStore[F]||(n.l.IncludesShadersStore[F]=L);let O="openpbrCoatLayerData",C=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
#endif
`;n.l.IncludesShadersStore[M]||(n.l.IncludesShadersStore[M]=P),i(29865);let G="openpbrEnvironmentLighting",z=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;n.l.IncludesShadersStore[x]||(n.l.IncludesShadersStore[x]=y);let U="openpbrDirectLighting",W=`#ifdef LIGHT{X}
...
#endif
`;n.l.IncludesShadersStore[U]||(n.l.IncludesShadersStore[U]=W),i(21401),i(56308),i(18353),i(93019),i(20680),i(35873);let X="openpbrPixelShader",B=`#define OPENPBR_FRAGMENT_SHADER
