...
return result;}
#endif
`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f);let n={name:t,shader:f}},74924:function(e,r,i){i.r(r),i.d(r,{backgroundPixelShaderWGSL:()=>a});var o=i(29416);i(30790),i(80352),i(48e3),i(34039),i(36125),i(84411),i(32335),i(14358),i(74456),i(70217),i(38677);let t="intersectionFunctions",f=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f),i(47417),i(38241),i(30438),i(71805);let n="backgroundPixelShader",l=`#include<backgroundUboDeclaration>
