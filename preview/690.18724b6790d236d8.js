"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["690"],{82326(e,i,t){var o=t(20854);t(90216);let n="backgroundUboDeclaration",f=`layout(std140,column_major) uniform;uniform Material
...
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f)},25802(e,i,t){var o=t(20854);let n="clusteredLightingFunctions",f=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f)},68708(e,i,t){t.r(i),t.d(i,{lightFragment:()=>l});var o=t(20854);let n="lightFragment",f=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f);let l={name:n,shader:f}},39702(e,i,t){t.r(i),t.d(i,{lightsFragmentFunctions:()=>l});var o=t(20854);t(82120),t(25802);let n="lightsFragmentFunctions",f=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f);let l={name:n,shader:f}},12073(e,i,t){t.r(i),t.d(i,{backgroundPixelShader:()=>d});var o=t(20854);let n="backgroundFragmentDeclaration",f=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
uniform vec2 projectedGroundInfos;
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f),t(82326),t(94953),t(82099),t(94548),t(37090),t(67964),t(39702),t(79456),t(97957),t(16681),t(43294),t(7826);let l="intersectionFunctions",r=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;o.l.IncludesShadersStore[l]||(o.l.IncludesShadersStore[l]=r),t(62776),t(68708),t(21401),t(56308);let a="backgroundPixelShader",s=`#ifdef TEXTURELODSUPPORT
