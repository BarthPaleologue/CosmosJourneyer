"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["3124"],{78770(e,a,r){r.r(a),r.d(a,{packingFunctionsWGSL:()=>f});var t=r(56863);let n="packingFunctions",i=`fn pack(depth: f32)->vec4f
{const bit_shift: vec4f= vec4f(255.0*255.0*255.0,255.0*255.0,255.0,1.0);const bit_mask: vec4f= vec4f(0.0,1.0/255.0,1.0/255.0,1.0/255.0);var res: vec4f=fract(depth*bit_shift);res-=res.xxyz*bit_mask;return res;}
fn unpack(color: vec4f)->f32
{const bit_shift: vec4f= vec4f(1.0/(255.0*255.0*255.0),1.0/(255.0*255.0),1.0/255.0,1.0);return dot(color,bit_shift);}`;t.l.IncludesShadersStoreWGSL[n]||(t.l.IncludesShadersStoreWGSL[n]=i);let f={name:n,shader:i}},2222(e,a,r){r.r(a),r.d(a,{shadowMapFragmentWGSL:()=>f});var t=r(56863);let n="shadowMapFragment",i=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
...
#endif
`;t.l.IncludesShadersStoreWGSL[n]||(t.l.IncludesShadersStoreWGSL[n]=i);let f={name:n,shader:i}},14431(e,a,r){r.r(a),r.d(a,{shadowMapPixelShaderWGSL:()=>o});var t=r(56863);r(78770);let n="bayerDitherFunctions",i=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;t.l.IncludesShadersStoreWGSL[n]||(t.l.IncludesShadersStoreWGSL[n]=i);let f="shadowMapFragmentExtraDeclaration",S=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;t.l.IncludesShadersStoreWGSL[f]||(t.l.IncludesShadersStoreWGSL[f]=S),r(64470),r(19456),r(2222);let s="shadowMapPixelShader",d=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;t.l.ShadersStoreWGSL[s]||(t.l.ShadersStoreWGSL[s]=d);let o={name:s,shader:d}}}]);