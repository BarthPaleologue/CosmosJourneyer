...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["9724"],{48584:function(e,a,r){r.r(a),r.d(a,{bumpFragmentWGSL:()=>t});var i=r(28345);let n="bumpFragment",f=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},69143:function(e,a,r){r.r(a),r.d(a,{bumpFragmentFunctionsWGSL:()=>t});var i=r(28345);r(79104);let n="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},91076:function(e,a,r){r.r(a),r.d(a,{bumpFragmentMainFunctionsWGSL:()=>t});var i=r(28345);let n="bumpFragmentMainFunctions",f=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
...
#endif
`;i.l.IncludesShadersStoreWGSL[t]||(i.l.IncludesShadersStoreWGSL[t]=o),r(80690),r(69972),r(66059),r(19780),r(93783),r(58758),r(72315),r(31953),r(62683),r(44526),r(56589),r(93761),r(12928),r(25651),r(18591),r(1626),r(1532),r(91076),r(69143),r(40993),r(34071);let c="pbrBlockAlbedoOpacity",l=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
return outParams;}
#endif
`;i.l.IncludesShadersStoreWGSL[_]||(i.l.IncludesShadersStoreWGSL[_]=M),r(90418),r(14381),r(48584);let D="pbrBlockNormalFinal",F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[D]||(i.l.IncludesShadersStoreWGSL[D]=F),r(30939);let g="pbrBlockLightmapInit",h=`#ifdef LIGHTMAP
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[P]||(i.l.IncludesShadersStoreWGSL[P]=b),r(4255);let U="pbrBlockReflectance",B=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
`;i.l.IncludesShadersStoreWGSL[y]||(i.l.IncludesShadersStoreWGSL[y]=x),r(94266);let G="pbrBlockFinalLitComponents",V=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
`;i.l.IncludesShadersStoreWGSL[Y]||(i.l.IncludesShadersStoreWGSL[Y]=k),r(60711),r(41858),r(97443),r(53249),r(62110),r(73551);let X="pbrPixelShader",w=`#define PBR_FRAGMENT_SHADER
