...
"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["2498"],{5657:function(e,t,r){var o=r(38700);let i="clusteredLightingFunctions",a=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
...
`;o.l.IncludesShadersStoreWGSL[i]||(o.l.IncludesShadersStoreWGSL[i]=a)},97227:function(e,t,r){r.r(t),r.d(t,{imageProcessingDeclarationWGSL:()=>f});var o=r(38700);let i="imageProcessingDeclaration",a=`#ifdef EXPOSURE
...
#endif
`;o.l.IncludesShadersStoreWGSL[i]||(o.l.IncludesShadersStoreWGSL[i]=a);let f={name:i,shader:a}},44634:function(e,t,r){r.r(t),r.d(t,{imageProcessingFunctionsWGSL:()=>f});var o=r(38700);let i="imageProcessingFunctions",a=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;o.l.IncludesShadersStoreWGSL[i]||(o.l.IncludesShadersStoreWGSL[i]=a);let f={name:i,shader:a}},16365:function(e,t,r){r.r(t),r.d(t,{lightFragmentWGSL:()=>f});var o=r(38700);let i="lightFragment",a=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.l.IncludesShadersStoreWGSL[i]||(o.l.IncludesShadersStoreWGSL[i]=a);let f={name:i,shader:a}},87065:function(e,t,r){r.r(t),r.d(t,{lightUboDeclarationWGSL:()=>f});var o=r(38700);let i="lightUboDeclaration",a=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
...
vec3f( 0,1,0 ),
vec3f( 0,0,1 )
);result.Diffuse+=LTCEvaluate( normal,viewDir,position,mInvEmpty,rectCoords0,rectCoords1,rectCoords2,rectCoords3 );return result;}`;o.l.IncludesShadersStoreWGSL[i]||(o.l.IncludesShadersStoreWGSL[i]=a)},68916:function(e,t,r){r.r(t),r.d(t,{reflectionFunctionWGSL:()=>f});var o=r(38700);let i="reflectionFunction",a=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;o.l.IncludesShadersStoreWGSL[i]||(o.l.IncludesShadersStoreWGSL[i]=a);let f={name:i,shader:a}},12579:function(e,t,r){r.r(t),r.d(t,{shadowsFragmentFunctionsWGSL:()=>f});var o=r(38700);let i="shadowsFragmentFunctions",a=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
