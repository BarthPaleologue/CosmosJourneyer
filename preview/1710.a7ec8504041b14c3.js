...
"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["1710"],{54384:function(e,i,n){n.r(i),n.d(i,{bumpFragment:()=>r});var a=n(38700);let t="bumpFragment",o=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o);let r={name:t,shader:o}},60879:function(e,i,n){n.r(i),n.d(i,{bumpFragmentFunctions:()=>r});var a=n(38700);n(28824);let t="bumpFragmentFunctions",o=`#if defined(BUMP)
...
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o);let r={name:t,shader:o}},64716:function(e,i,n){n.r(i),n.d(i,{bumpFragmentMainFunctions:()=>r});var a=n(38700);let t="bumpFragmentMainFunctions",o=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#ifdef OBJECTSPACE_NORMALMAP
...
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o);let r={name:t,shader:o}},15215:function(e,i,n){var a=n(38700);let t="decalFragment",o=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},96947:function(e,i,n){var a=n(38700);let t="decalFragmentDeclaration",o=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},675:function(e,i,n){var a=n(38700);let t="depthPrePass",o=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},80469:function(e,i,n){var a=n(38700);let t="harmonicsFunctions",o=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},53719:function(e,i,n){var a=n(38700);let t="hdrFilteringFunctions",o=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},73203:function(e,i,n){var a=n(38700);let t="importanceSampling",o=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},77774:function(e,i,n){var a=n(38700);let t="mainUVVaryingDeclaration",o=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},58104:function(e,i,n){var a=n(38700);let t="oitDeclaration",o=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},78918:function(e,i,n){var a=n(38700);let t="oitFragment",o=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},41867:function(e,i,n){var a=n(38700);let t="pbrBRDFFunctions",o=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},28824:function(e,i,n){var a=n(38700);let t="samplerFragmentDeclaration",o=`#ifdef _DEFINENAME_
...
#endif
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},73697:function(e,i,n){var a=n(38700);let t="subSurfaceScatteringFunctions",o=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o)},17885:function(e,i,n){n.r(i),n.d(i,{pbrPixelShader:()=>eS});var a=n(38700);n(2900),n(58104),n(96947);let t="pbrFragmentDeclaration",o=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;a.l.IncludesShadersStore[t]||(a.l.IncludesShadersStore[t]=o),n(17286),n(77774);let r="pbrFragmentExtraDeclaration",f=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;a.l.IncludesShadersStore[r]||(a.l.IncludesShadersStore[r]=f),n(93620),n(44258),n(28824);let l="samplerFragmentAlternateDeclaration",c=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
`;a.l.IncludesShadersStore[d]||(a.l.IncludesShadersStore[d]=s),n(14266),n(48268),n(62883),n(10540),n(66207),n(73697),n(73203);let E="pbrHelperFunctions",u=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;a.l.IncludesShadersStore[E]||(a.l.IncludesShadersStore[E]=u),n(64163),n(79110),n(80469),n(78814);let R="pbrDirectLightingSetupFunctions",m=`struct preLightingInfo
...
#endif
}`;a.l.IncludesShadersStore[C]||(a.l.IncludesShadersStore[C]=v),n(41867),n(53719);let S="pbrDirectLightingFunctions",A=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SS_TRANSLUCENCY
...
#endif
`;a.l.IncludesShadersStore[I]||(a.l.IncludesShadersStore[I]=N),n(64716),n(60879),n(85721),n(15215);let p="pbrBlockAlbedoOpacity",O=`struct albedoOpacityOutParams
...
return outParams;}
#endif
`;a.l.IncludesShadersStore[H]||(a.l.IncludesShadersStore[H]=W),n(37912);let X="pbrBlockReflectance0",Y=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
...
return result;}
#endif
`;a.l.IncludesShadersStore[k]||(a.l.IncludesShadersStore[k]=w),n(46394);let z="pbrBlockNormalGeometric",q=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;a.l.IncludesShadersStore[z]||(a.l.IncludesShadersStore[z]=q),n(54384);let K="pbrBlockNormalFinal",Z=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;a.l.IncludesShadersStore[K]||(a.l.IncludesShadersStore[K]=Z),n(675);let J="pbrBlockLightmapInit",j=`#ifdef LIGHTMAP
...
#endif
`;a.l.IncludesShadersStore[en]||(a.l.IncludesShadersStore[en]=ea),n(64178);let et="pbrBlockFinalLitComponents",eo=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
`;a.l.IncludesShadersStore[el]||(a.l.IncludesShadersStore[el]=ec),n(53039),n(56154);let ed="pbrBlockImageProcessing",es=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
#endif
`;a.l.IncludesShadersStore[eE]||(a.l.IncludesShadersStore[eE]=eu),n(78918);let eR="pbrDebug",em=`#if DEBUGMODE>0
