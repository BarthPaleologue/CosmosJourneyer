"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["5364"],{69226:function(e,a,i){i.r(a),i.d(a,{clipPlaneFragmentWGSL:()=>t});var f=i(22081);let n="clipPlaneFragment",r=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;f.l.IncludesShadersStoreWGSL[n]||(f.l.IncludesShadersStoreWGSL[n]=r);let t={name:n,shader:r}},51644:function(e,a,i){i.r(a),i.d(a,{clipPlaneFragmentDeclarationWGSL:()=>t});var f=i(22081);let n="clipPlaneFragmentDeclaration",r=`#ifdef CLIPPLANE
...
#endif
`;f.l.IncludesShadersStoreWGSL[n]||(f.l.IncludesShadersStoreWGSL[n]=r);let t={name:n,shader:r}},1832:function(e,a,i){i.r(a),i.d(a,{packingFunctionsWGSL:()=>t});var f=i(22081);let n="packingFunctions",r=`fn pack(depth: f32)->vec4f
{const bit_shift: vec4f= vec4f(255.0*255.0*255.0,255.0*255.0,255.0,1.0);const bit_mask: vec4f= vec4f(0.0,1.0/255.0,1.0/255.0,1.0/255.0);var res: vec4f=fract(depth*bit_shift);res-=res.xxyz*bit_mask;return res;}
fn unpack(color: vec4f)->f32
{const bit_shift: vec4f= vec4f(1.0/(255.0*255.0*255.0),1.0/(255.0*255.0),1.0/255.0,1.0);return dot(color,bit_shift);}`;f.l.IncludesShadersStoreWGSL[n]||(f.l.IncludesShadersStoreWGSL[n]=r);let t={name:n,shader:r}},69940:function(e,a,i){i.r(a),i.d(a,{shadowMapFragmentWGSL:()=>t});var f=i(22081);let n="shadowMapFragment",r=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
...
#endif
`;f.l.IncludesShadersStoreWGSL[n]||(f.l.IncludesShadersStoreWGSL[n]=r);let t={name:n,shader:r}},39055:function(e,a,i){i.r(a),i.d(a,{shadowMapPixelShaderWGSL:()=>l});var f=i(22081);i(1832);let n="bayerDitherFunctions",r=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
varying zSM: f32;
#endif
`;f.l.IncludesShadersStoreWGSL[t]||(f.l.IncludesShadersStoreWGSL[t]=d),i(51644),i(69226),i(69940);let s="shadowMapPixelShader",S=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
