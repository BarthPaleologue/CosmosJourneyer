...
`;n.l.IncludesShadersStore[a]||(n.l.IncludesShadersStore[a]=t),i(88877),i(80671),i(4741),i(59513),i(12602);let r="openpbrFragmentSamplersDeclaration",l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;n.l.IncludesShadersStore[r]||(n.l.IncludesShadersStore[r]=l),i(28363),i(41669),i(68908),i(85081),i(61244),i(19961),i(5258),i(19028),i(92730),i(84003),i(53364),i(76978),i(33559),i(82542),i(3120),i(63795),i(12927);let f="openpbrNormalMapFragmentMainFunctions",c=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;n.l.IncludesShadersStore[f]||(n.l.IncludesShadersStore[f]=c);let s="openpbrNormalMapFragmentFunctions",d=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;n.l.IncludesShadersStore[s]||(n.l.IncludesShadersStore[s]=d),i(42388);let m="openpbrDielectricReflectance",u=`struct ReflectanceParams
...
`;n.l.IncludesShadersStore[m]||(n.l.IncludesShadersStore[m]=u);let _="openpbrConductorReflectance",g=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;n.l.IncludesShadersStore[_]||(n.l.IncludesShadersStore[_]=g);let v="openpbrBlockAmbientOcclusion",p=`struct ambientOcclusionOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;n.l.IncludesShadersStore[I]||(n.l.IncludesShadersStore[I]=E);let h="openpbrIblFunctions",R=`#ifdef REFLECTION
...
#endif
`;n.l.IncludesShadersStore[h]||(n.l.IncludesShadersStore[h]=R),i(15149),i(10422);let N="openpbrNormalMapFragment",A=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;n.l.IncludesShadersStore[N]||(n.l.IncludesShadersStore[N]=A);let S="openpbrBlockNormalFinal",F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;n.l.IncludesShadersStore[S]||(n.l.IncludesShadersStore[S]=F);let T="openpbrBaseLayerData",L=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;n.l.IncludesShadersStore[T]||(n.l.IncludesShadersStore[T]=L);let O="openpbrCoatLayerData",C=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;n.l.IncludesShadersStore[O]||(n.l.IncludesShadersStore[O]=C);let b="openpbrThinFilmLayerData",D=`#ifdef THIN_FILM
...
#endif
#endif
`;n.l.IncludesShadersStore[b]||(n.l.IncludesShadersStore[b]=D);let M="openpbrFuzzLayerData",P=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;n.l.IncludesShadersStore[M]||(n.l.IncludesShadersStore[M]=P),i(6170);let G="openpbrEnvironmentLighting",z=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;n.l.IncludesShadersStore[G]||(n.l.IncludesShadersStore[G]=z);let x="openpbrDirectLightingInit",y=`#ifdef LIGHT{X}
...
#endif
#endif
`;n.l.IncludesShadersStore[x]||(n.l.IncludesShadersStore[x]=y);let W="openpbrDirectLighting",U=`#ifdef LIGHT{X}
...
#endif
`;n.l.IncludesShadersStore[W]||(n.l.IncludesShadersStore[W]=U),i(34898),i(67337),i(69728),i(17302),i(65785),i(30090);let X="openpbrPixelShader",B=`#define OPENPBR_FRAGMENT_SHADER
...
`;n.l.ShadersStore[X]||(n.l.ShadersStore[X]=B);let H={name:X,shader:B}}}]);