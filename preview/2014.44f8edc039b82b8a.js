"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["2014"],{73408(e,i,o){var t=o(77948);o(34990);let l="backgroundUboDeclaration",r=`layout(std140,column_major) uniform;uniform Material
...
`;t.l.IncludesShadersStore[l]||(t.l.IncludesShadersStore[l]=r)},20608(e,i,o){o.r(i),o.d(i,{lightsFragmentFunctions:()=>n});var t=o(77948);o(31630),o(92667);let l="lightsFragmentFunctions",r=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;t.l.IncludesShadersStore[l]||(t.l.IncludesShadersStore[l]=r);let n={name:l,shader:r}},54413(e,i,o){o.r(i),o.d(i,{backgroundPixelShader:()=>s});var t=o(77948);let l="backgroundFragmentDeclaration",r=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
uniform vec2 projectedGroundInfos;
#endif
`;t.l.IncludesShadersStore[l]||(t.l.IncludesShadersStore[l]=r),o(73408),o(41007),o(70121),o(62762),o(40164),o(83858),o(20608),o(39094),o(90131),o(60243),o(18300),o(97340);let n="intersectionFunctions",f=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;t.l.IncludesShadersStore[n]||(t.l.IncludesShadersStore[n]=f),o(42794),o(76802),o(62975),o(86826);let a="backgroundPixelShader",c=`#ifdef TEXTURELODSUPPORT
