"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["2506"],{25802(e,i,t){var o=t(20854);let s="clusteredLightingFunctions",n=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;o.l.IncludesShadersStore[s]||(o.l.IncludesShadersStore[s]=n)},29496(e,i,t){var o=t(20854);let s="sceneVertexDeclaration",n=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
uniform mat4 viewProjectionR;
#endif
uniform mat4 view;uniform mat4 projection;uniform vec4 vEyePosition;
`;o.l.IncludesShadersStore[s]||(o.l.IncludesShadersStore[s]=n)},42577(e,i,t){t.r(i),t.d(i,{lightProxyVertexShader:()=>a});var o=t(20854);t(29496),t(90216),t(25802);let s="lightProxyVertexShader",n=`attribute vec3 position;flat varying vec2 vLimits;flat varying highp uint vMask;
