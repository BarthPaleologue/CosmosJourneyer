...
`;n.l.IncludesShadersStore[a]||(n.l.IncludesShadersStore[a]=t),i(73150),i(30112),i(27896),i(89294),i(14284);let r="openpbrFragmentSamplersDeclaration",l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;n.l.IncludesShadersStore[r]||(n.l.IncludesShadersStore[r]=l),i(69614),i(74024),i(94903),i(46992),i(47291),i(31754),i(2327),i(78925),i(96631),i(17642),i(35545),i(49157),i(33068),i(57607),i(17555),i(28526),i(27104);let c="openpbrNormalMapFragmentMainFunctions",f=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;n.l.IncludesShadersStore[c]||(n.l.IncludesShadersStore[c]=f);let s="openpbrNormalMapFragmentFunctions",d=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;n.l.IncludesShadersStore[s]||(n.l.IncludesShadersStore[s]=d),i(44333);let m="openpbrDielectricReflectance",u=`struct ReflectanceParams
...
#endif
`;n.l.IncludesShadersStore[I]||(n.l.IncludesShadersStore[I]=E);let R="openpbrIblFunctions",h=`#ifdef REFLECTION
...
#endif
`;n.l.IncludesShadersStore[R]||(n.l.IncludesShadersStore[R]=h),i(21358),i(82361);let A="openpbrNormalMapFragment",N=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;n.l.IncludesShadersStore[A]||(n.l.IncludesShadersStore[A]=N);let S="openpbrBlockNormalFinal",T=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;n.l.IncludesShadersStore[S]||(n.l.IncludesShadersStore[S]=T);let L="openpbrBaseLayerData",O=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;n.l.IncludesShadersStore[L]||(n.l.IncludesShadersStore[L]=O);let C="openpbrCoatLayerData",F=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;n.l.IncludesShadersStore[C]||(n.l.IncludesShadersStore[C]=F);let b="openpbrThinFilmLayerData",D=`#ifdef THIN_FILM
...
#endif
#endif
`;n.l.IncludesShadersStore[b]||(n.l.IncludesShadersStore[b]=D),i(57743);let M="openpbrEnvironmentLighting",P=`#ifdef REFLECTION
...
#endif
`;n.l.IncludesShadersStore[M]||(n.l.IncludesShadersStore[M]=P);let G="openpbrDirectLightingInit",x=`#ifdef LIGHT{X}
...
#endif
#endif
`;n.l.IncludesShadersStore[G]||(n.l.IncludesShadersStore[G]=x);let y="openpbrDirectLighting",X=`#ifdef LIGHT{X}
...
#endif
`;n.l.IncludesShadersStore[y]||(n.l.IncludesShadersStore[y]=X),i(60971),i(40998),i(60583),i(93781),i(44042),i(60739);let W="openpbrPixelShader",U=`#define OPENPBR_FRAGMENT_SHADER
...
`;n.l.ShadersStore[W]||(n.l.ShadersStore[W]=U);let B={name:W,shader:U}}}]);