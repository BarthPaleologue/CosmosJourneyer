...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=o),a(80690),a(69972),a(66059),a(19780),a(93783),a(58758),a(72315),a(31953),a(62683),a(44526),a(56589),a(93761),a(12928),a(25651),a(18591),a(1626),a(1532);let t="openpbrNormalMapFragmentMainFunctions",f=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;i.l.IncludesShadersStoreWGSL[t]||(i.l.IncludesShadersStoreWGSL[t]=f);let l="openpbrNormalMapFragmentFunctions",c=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;i.l.IncludesShadersStoreWGSL[l]||(i.l.IncludesShadersStoreWGSL[l]=c),a(40993);let s="openpbrDielectricReflectance",m=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;i.l.IncludesShadersStoreWGSL[s]||(i.l.IncludesShadersStoreWGSL[s]=m);let u="openpbrConductorReflectance",d=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;i.l.IncludesShadersStoreWGSL[u]||(i.l.IncludesShadersStoreWGSL[u]=d);let p="openpbrBlockAmbientOcclusion",g=`struct ambientOcclusionOutParams
...
`;i.l.IncludesShadersStoreWGSL[p]||(i.l.IncludesShadersStoreWGSL[p]=g);let _="openpbrGeometryInfo",v=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;i.l.IncludesShadersStoreWGSL[_]||(i.l.IncludesShadersStoreWGSL[_]=v);let I="openpbrIblFunctions",S=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;i.l.IncludesShadersStoreWGSL[I]||(i.l.IncludesShadersStoreWGSL[I]=S),a(90418),a(14381);let h="openpbrNormalMapFragment",E=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;i.l.IncludesShadersStoreWGSL[h]||(i.l.IncludesShadersStoreWGSL[h]=E);let R="openpbrBlockNormalFinal",N=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;i.l.IncludesShadersStoreWGSL[L]||(i.l.IncludesShadersStoreWGSL[L]=A);let F="openpbrCoatLayerData",T=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;i.l.IncludesShadersStoreWGSL[F]||(i.l.IncludesShadersStoreWGSL[F]=T);let O="openpbrThinFilmLayerData",b=`#ifdef THIN_FILM
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[O]||(i.l.IncludesShadersStoreWGSL[O]=b);let C="openpbrFuzzLayerData",M=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[C]||(i.l.IncludesShadersStoreWGSL[C]=M),a(30939);let D="openpbrEnvironmentLighting",x=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[D]||(i.l.IncludesShadersStoreWGSL[D]=x);let G="openpbrDirectLightingInit",z=`#ifdef LIGHT{X}
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[G]||(i.l.IncludesShadersStoreWGSL[G]=z);let P="openpbrDirectLighting",y=`#ifdef LIGHT{X}
...
#endif
`;i.l.IncludesShadersStoreWGSL[P]||(i.l.IncludesShadersStoreWGSL[P]=y),a(60711),a(41858),a(97443),a(53249),a(62110),a(73551);let W="openpbrPixelShader",U=`#define OPENPBR_FRAGMENT_SHADER
...
`;i.l.ShadersStoreWGSL[W]||(i.l.ShadersStoreWGSL[W]=U);let X={name:W,shader:U}}}]);