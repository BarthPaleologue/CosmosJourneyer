...
`;a.l.IncludesShadersStore[r]||(a.l.IncludesShadersStore[r]=f),n(81690),n(30112),n(27896),n(89294),n(14284);let o="samplerFragmentAlternateDeclaration",t=`#ifdef _DEFINENAME_
...
#endif
`;a.l.IncludesShadersStore[c]||(a.l.IncludesShadersStore[c]=l),n(69614),n(74024),n(94903),n(46992),n(47291),n(31754),n(2327),n(78925),n(96631),n(17642),n(35545),n(49157),n(33068),n(57607),n(17555),n(28526),n(27104),n(37536),n(51555),n(44333),n(55099);let d="pbrBlockAlbedoOpacity",s=`struct albedoOpacityOutParams
...
`;a.l.IncludesShadersStore[E]||(a.l.IncludesShadersStore[E]=R);let C="pbrBlockAmbientOcclusion",u=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;a.l.IncludesShadersStore[C]||(a.l.IncludesShadersStore[C]=u);let S="pbrBlockAlphaFresnel",m=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;a.l.IncludesShadersStore[S]||(a.l.IncludesShadersStore[S]=m);let I="pbrBlockAnisotropic",A=`#ifdef ANISOTROPIC
...
#endif
`;a.l.IncludesShadersStore[I]||(a.l.IncludesShadersStore[I]=A);let v="pbrBlockReflection",N=`#ifdef REFLECTION
...
#endif
`;a.l.IncludesShadersStore[v]||(a.l.IncludesShadersStore[v]=N);let T="pbrBlockSheen",O=`#ifdef SHEEN
...
return outParams;}
#endif
`;a.l.IncludesShadersStore[D]||(a.l.IncludesShadersStore[D]=h),n(70716);let F="pbrBlockReflectance0",g=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;a.l.IncludesShadersStore[F]||(a.l.IncludesShadersStore[F]=g);let P="pbrClusteredLightingFunctions",U=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;a.l.IncludesShadersStore[P]||(a.l.IncludesShadersStore[P]=U),n(21358),n(82361),n(3180);let b="pbrBlockNormalFinal",y=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;a.l.IncludesShadersStore[b]||(a.l.IncludesShadersStore[b]=y),n(57743);let B="pbrBlockLightmapInit",G=`#ifdef LIGHTMAP
...
#endif
`;a.l.IncludesShadersStore[B]||(a.l.IncludesShadersStore[B]=G);let V="pbrBlockGeometryInfo",H=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;a.l.IncludesShadersStore[x]||(a.l.IncludesShadersStore[x]=W);let Y="pbrBlockDirectLighting",k=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;a.l.IncludesShadersStore[Y]||(a.l.IncludesShadersStore[Y]=k),n(28222);let X="pbrBlockFinalLitComponents",w=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;a.l.IncludesShadersStore[X]||(a.l.IncludesShadersStore[X]=w);let K="pbrBlockFinalUnlitComponents",z=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;a.l.IncludesShadersStore[K]||(a.l.IncludesShadersStore[K]=z);let Z="pbrBlockFinalColorComposition",q=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;a.l.IncludesShadersStore[Z]||(a.l.IncludesShadersStore[Z]=q),n(60971),n(40998),n(60583),n(93781),n(44042),n(60739);let J="pbrPixelShader",j=`#define PBR_FRAGMENT_SHADER
