...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["9574"],{77681(e,o,t){t.r(o),t.d(o,{imageProcessingDeclaration:()=>s});var r=t(56863);let i="imageProcessingDeclaration",a=`#ifdef EXPOSURE
...
#endif
`;r.l.IncludesShadersStore[i]||(r.l.IncludesShadersStore[i]=a);let s={name:i,shader:a}},69544(e,o,t){t.r(o),t.d(o,{imageProcessingFunctions:()=>s});var r=t(56863);let i="imageProcessingFunctions",a=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;r.l.IncludesShadersStore[i]||(r.l.IncludesShadersStore[i]=a);let s={name:i,shader:a}},47791(e,o,t){t.r(o),t.d(o,{lightFragmentDeclaration:()=>s});var r=t(56863);let i="lightFragmentDeclaration",a=`#ifdef LIGHT{X}
...
#endif
#endif
`;r.l.IncludesShadersStore[i]||(r.l.IncludesShadersStore[i]=a);let s={name:i,shader:a}},9063(e,o,t){t.r(o),t.d(o,{lightUboDeclaration:()=>s});var r=t(56863);let i="lightUboDeclaration",a=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;r.l.IncludesShadersStore[i]||(r.l.IncludesShadersStore[i]=a)},96554(e,o,t){t.r(o),t.d(o,{reflectionFunction:()=>s});var r=t(56863);let i="reflectionFunction",a=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;r.l.IncludesShadersStore[i]||(r.l.IncludesShadersStore[i]=a);let s={name:i,shader:a}},913(e,o,t){t.r(o),t.d(o,{shadowsFragmentFunctions:()=>s});var r=t(56863);let i="shadowsFragmentFunctions",a=`#ifdef SHADOWS
