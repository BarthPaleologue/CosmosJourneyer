...
`;n.l.IncludesShadersStore[a]||(n.l.IncludesShadersStore[a]=t),i(41670),i(5512),i(1008),i(12966),i(99188);let r="openpbrFragmentSamplersDeclaration",l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;n.l.IncludesShadersStore[r]||(n.l.IncludesShadersStore[r]=l),i(37318),i(67888),i(29343),i(99048),i(68595),i(86402),i(39743),i(82069),i(80655),i(24018),i(79121),i(90493),i(86164),i(43119),i(94011),i(19798),i(12216);let f="openpbrNormalMapFragmentMainFunctions",c=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;n.l.IncludesShadersStore[s]||(n.l.IncludesShadersStore[s]=d),i(27413);let m="openpbrDielectricReflectance",u=`struct ReflectanceParams
...
#endif
`;n.l.IncludesShadersStore[h]||(n.l.IncludesShadersStore[h]=R),i(13030),i(34801);let N="openpbrNormalMapFragment",A=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
#endif
`;n.l.IncludesShadersStore[M]||(n.l.IncludesShadersStore[M]=P),i(64871);let G="openpbrEnvironmentLighting",z=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
`;n.l.IncludesShadersStore[W]||(n.l.IncludesShadersStore[W]=U),i(87235),i(42990),i(52511),i(66941),i(74050),i(40395);let X="openpbrPixelShader",B=`#define OPENPBR_FRAGMENT_SHADER
