...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=o),a(76251),a(98997),a(84444),a(21161),a(22636),a(78665),a(77146),a(6372),a(98186),a(45747),a(68004),a(13570),a(63911),a(99550),a(1888),a(93635),a(52719);let t="openpbrNormalMapFragmentMainFunctions",f=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;i.l.IncludesShadersStoreWGSL[l]||(i.l.IncludesShadersStoreWGSL[l]=c),a(70884);let s="openpbrDielectricReflectance",m=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
#endif
`;i.l.IncludesShadersStoreWGSL[I]||(i.l.IncludesShadersStoreWGSL[I]=S),a(82589),a(89958);let h="openpbrNormalMapFragment",E=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[C]||(i.l.IncludesShadersStoreWGSL[C]=M),a(48106);let D="openpbrEnvironmentLighting",x=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
`;i.l.IncludesShadersStoreWGSL[z]||(i.l.IncludesShadersStoreWGSL[z]=y),a(12194),a(87641),a(56464),a(73350),a(45577),a(59802);let W="openpbrPixelShader",U=`#define OPENPBR_FRAGMENT_SHADER
