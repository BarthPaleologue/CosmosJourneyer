...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["9389"],{62762(e,o,t){t.r(o),t.d(o,{imageProcessingDeclaration:()=>s});var r=t(77948);let i="imageProcessingDeclaration",a=`#ifdef EXPOSURE
...
#endif
`;r.l.IncludesShadersStore[i]||(r.l.IncludesShadersStore[i]=a);let s={name:i,shader:a}},90131(e,o,t){t.r(o),t.d(o,{imageProcessingFunctions:()=>s});var r=t(77948);let i="imageProcessingFunctions",a=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;r.l.IncludesShadersStore[i]||(r.l.IncludesShadersStore[i]=a);let s={name:i,shader:a}},40164(e,o,t){t.r(o),t.d(o,{lightFragmentDeclaration:()=>s});var r=t(77948);let i="lightFragmentDeclaration",a=`#ifdef LIGHT{X}
...
#endif
#endif
`;r.l.IncludesShadersStore[i]||(r.l.IncludesShadersStore[i]=a);let s={name:i,shader:a}},83858(e,o,t){t.r(o),t.d(o,{lightUboDeclaration:()=>s});var r=t(77948);let i="lightUboDeclaration",a=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;r.l.IncludesShadersStore[i]||(r.l.IncludesShadersStore[i]=a)},70121(e,o,t){t.r(o),t.d(o,{reflectionFunction:()=>s});var r=t(77948);let i="reflectionFunction",a=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;r.l.IncludesShadersStore[i]||(r.l.IncludesShadersStore[i]=a);let s={name:i,shader:a}},39094(e,o,t){t.r(o),t.d(o,{shadowsFragmentFunctions:()=>s});var r=t(77948);let i="shadowsFragmentFunctions",a=`#ifdef SHADOWS
...
#endif
#endif
`;r.l.IncludesShadersStore[i]||(r.l.IncludesShadersStore[i]=a);let s={name:i,shader:a}}}]);