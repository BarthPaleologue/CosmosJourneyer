"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["8879"],{97970:function(e,r,t){t.r(r),t.d(r,{iblIcdfPixelShaderWGSL:()=>u});var a=t(68415);t(29969);let i="iblIcdfPixelShader",c=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;a.l.ShadersStoreWGSL[i]||(a.l.ShadersStoreWGSL[i]=c);let u={name:i,shader:c}}}]);