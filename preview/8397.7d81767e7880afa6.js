"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["8397"],{12876:function(e,t,o){var a=o(34981);let n="hdrFilteringFunctions",i=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;a.l.IncludesShadersStore[n]||(a.l.IncludesShadersStore[n]=i)},89758:function(e,t,o){var a=o(34981);let n="importanceSampling",i=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;a.l.IncludesShadersStore[n]||(a.l.IncludesShadersStore[n]=i)},97914:function(e,t,o){var a=o(34981);let n="pbrBRDFFunctions",i=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;a.l.IncludesShadersStore[n]||(a.l.IncludesShadersStore[n]=i)},80268:function(e,t,o){o.r(t),o.d(t,{hdrFilteringPixelShader:()=>l});var a=o(34981);o(13384),o(89758),o(97914),o(12876);let n="hdrFilteringPixelShader",i=`#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
uniform float alphaG;uniform samplerCube inputTexture;uniform vec2 vFilteringInfo;uniform float hdrScale;varying vec3 direction;void main() {vec3 color=radiance(alphaG,inputTexture,direction,vFilteringInfo);gl_FragColor=vec4(color*hdrScale,1.0);}`;a.l.ShadersStore[n]||(a.l.ShadersStore[n]=i);let l={name:n,shader:i}}}]);