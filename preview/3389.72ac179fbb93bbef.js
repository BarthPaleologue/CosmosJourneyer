...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["3389"],{81795(e,i,n){n.r(i),n.d(i,{bumpFragment:()=>o});var a=n(56863);let r="bumpFragment",f=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;a.l.IncludesShadersStore[r]||(a.l.IncludesShadersStore[r]=f);let o={name:r,shader:f}},5854(e,i,n){n.r(i),n.d(i,{bumpFragmentFunctions:()=>o});var a=n(56863);n(64571);let r="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;a.l.IncludesShadersStore[r]||(a.l.IncludesShadersStore[r]=f);let o={name:r,shader:f}},72741(e,i,n){n.r(i),n.d(i,{bumpFragmentMainFunctions:()=>o});var a=n(56863);let r="bumpFragmentMainFunctions",f=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#ifdef OBJECTSPACE_NORMALMAP
...
#endif
`;a.l.IncludesShadersStore[r]||(a.l.IncludesShadersStore[r]=f);let o={name:r,shader:f}},25174(e,i,n){var a=n(56863);let r="decalFragment",f=`#ifdef DECAL
#ifdef GAMMADECAL
...
`;a.l.IncludesShadersStore[r]||(a.l.IncludesShadersStore[r]=f),n(823),n(12685),n(47791),n(9063),n(64571);let o="samplerFragmentAlternateDeclaration",t=`#ifdef _DEFINENAME_
...
#endif
`;a.l.IncludesShadersStore[c]||(a.l.IncludesShadersStore[c]=l),n(77681),n(8779),n(32654),n(47083),n(56754),n(88007),n(12228),n(34510),n(69544),n(913),n(63214),n(42124),n(42357),n(20920),n(37598),n(15221),n(56653),n(72741),n(5854),n(96554),n(25174);let d="pbrBlockAlbedoOpacity",s=`struct albedoOpacityOutParams
...
return outParams;}
#endif
`;a.l.IncludesShadersStore[D]||(a.l.IncludesShadersStore[D]=h),n(32991);let F="pbrBlockReflectance0",g=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
...
return result;}
#endif
`;a.l.IncludesShadersStore[P]||(a.l.IncludesShadersStore[P]=b),n(64023),n(49660),n(81795);let U="pbrBlockNormalFinal",B=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;a.l.IncludesShadersStore[U]||(a.l.IncludesShadersStore[U]=B),n(15260);let y="pbrBlockLightmapInit",G=`#ifdef LIGHTMAP
...
#endif
`;a.l.IncludesShadersStore[Y]||(a.l.IncludesShadersStore[Y]=X),n(18899);let k="pbrBlockFinalLitComponents",w=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
`;a.l.IncludesShadersStore[Z]||(a.l.IncludesShadersStore[Z]=q),n(29832),n(98999),n(37970),n(53164),n(41063),n(94312);let J="pbrPixelShader",j=`#define PBR_FRAGMENT_SHADER
