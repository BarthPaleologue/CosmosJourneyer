...
return result;}
#endif
`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f);let n={name:t,shader:f}},95777:function(e,r,i){i.r(r),i.d(r,{backgroundPixelShaderWGSL:()=>a});var o=i(22081);i(65888),i(41647),i(65033),i(36650),i(67506),i(50720),i(66998),i(94323),i(67827),i(51644),i(39580);let t="intersectionFunctions",f=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f),i(69226),i(45346),i(23199),i(36362);let n="backgroundPixelShader",l=`#include<backgroundUboDeclaration>
