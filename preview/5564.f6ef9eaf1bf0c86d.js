...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["5564"],{28363:function(e,o,t){t.r(o),t.d(o,{imageProcessingDeclaration:()=>s});var i=t(28345);let r="imageProcessingDeclaration",a=`#ifdef EXPOSURE
...
#endif
`;i.l.IncludesShadersStore[r]||(i.l.IncludesShadersStore[r]=a);let s={name:r,shader:a}},92730:function(e,o,t){t.r(o),t.d(o,{imageProcessingFunctions:()=>s});var i=t(28345);let r="imageProcessingFunctions",a=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;i.l.IncludesShadersStore[r]||(i.l.IncludesShadersStore[r]=a);let s={name:r,shader:a}},4741:function(e,o,t){t.r(o),t.d(o,{lightFragmentDeclaration:()=>s});var i=t(28345);let r="lightFragmentDeclaration",a=`#ifdef LIGHT{X}
...
#endif
#endif
`;i.l.IncludesShadersStore[r]||(i.l.IncludesShadersStore[r]=a);let s={name:r,shader:a}},59513:function(e,o,t){t.r(o),t.d(o,{lightUboDeclaration:()=>s});var i=t(28345);let r="lightUboDeclaration",a=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;i.l.IncludesShadersStore[r]||(i.l.IncludesShadersStore[r]=a)},42388:function(e,o,t){t.r(o),t.d(o,{reflectionFunction:()=>s});var i=t(28345);let r="reflectionFunction",a=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;i.l.IncludesShadersStore[r]||(i.l.IncludesShadersStore[r]=a);let s={name:r,shader:a}},84003:function(e,o,t){t.r(o),t.d(o,{shadowsFragmentFunctions:()=>s});var i=t(28345);let r="shadowsFragmentFunctions",a=`#ifdef SHADOWS
