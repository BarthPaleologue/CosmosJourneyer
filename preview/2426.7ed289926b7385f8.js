...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["2426"],{96510:function(e,a,r){r.r(a),r.d(a,{bumpFragmentWGSL:()=>t});var i=r(68415);let n="bumpFragment",f=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},34137:function(e,a,r){r.r(a),r.d(a,{bumpFragmentFunctionsWGSL:()=>t});var i=r(68415);r(85370);let n="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},64562:function(e,a,r){r.r(a),r.d(a,{bumpFragmentMainFunctionsWGSL:()=>t});var i=r(68415);let n="bumpFragmentMainFunctions",f=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
...
#endif
`;i.l.IncludesShadersStoreWGSL[t]||(i.l.IncludesShadersStoreWGSL[t]=o),r(71196),r(5430),r(91873),r(85402),r(29969),r(76672),r(58361),r(94655),r(18125),r(984),r(32627),r(32063),r(93154),r(15945),r(6777),r(7632),r(76702),r(64562),r(34137),r(71499),r(82473);let c="pbrBlockAlbedoOpacity",l=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
return outParams;}
#endif
`;i.l.IncludesShadersStoreWGSL[_]||(i.l.IncludesShadersStoreWGSL[_]=M),r(40128),r(59391),r(96510);let D="pbrBlockNormalFinal",F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[D]||(i.l.IncludesShadersStoreWGSL[D]=F),r(15953);let g="pbrBlockLightmapInit",h=`#ifdef LIGHTMAP
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[P]||(i.l.IncludesShadersStoreWGSL[P]=b),r(62469);let U="pbrBlockReflectance",B=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
`;i.l.IncludesShadersStoreWGSL[y]||(i.l.IncludesShadersStoreWGSL[y]=x),r(6620);let G="pbrBlockFinalLitComponents",V=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
`;i.l.IncludesShadersStoreWGSL[Y]||(i.l.IncludesShadersStoreWGSL[Y]=k),r(40513),r(99756),r(26745),r(69491),r(86576),r(74809);let X="pbrPixelShader",w=`#define PBR_FRAGMENT_SHADER
