...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["312"],{82788(e,i,t){t.r(i),t.d(i,{bumpFragment:()=>f});var a=t(17984);let o="bumpFragment",n=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;a.l.IncludesShadersStore[o]||(a.l.IncludesShadersStore[o]=n);let f={name:o,shader:n}},16043(e,i,t){t.r(i),t.d(i,{bumpFragmentFunctions:()=>f});var a=t(17984);t(99188);let o="bumpFragmentFunctions",n=`#if defined(BUMP)
...
#endif
`;a.l.IncludesShadersStore[o]||(a.l.IncludesShadersStore[o]=n);let f={name:o,shader:n}},41816(e,i,t){t.r(i),t.d(i,{bumpFragmentMainFunctions:()=>f});var a=t(17984);let o="bumpFragmentMainFunctions",n=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#ifdef OBJECTSPACE_NORMALMAP
...
#endif
`;a.l.IncludesShadersStore[o]||(a.l.IncludesShadersStore[o]=n);let f={name:o,shader:n}},61348(e,i,t){var a=t(17984);let o="clusteredLightingFunctions",n=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;a.l.IncludesShadersStore[o]||(a.l.IncludesShadersStore[o]=n)},56163(e,i,t){var a=t(17984);let o="decalFragment",n=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;a.l.IncludesShadersStore[o]||(a.l.IncludesShadersStore[o]=n)},65446(e,i,t){t.r(i),t.d(i,{lightFragment:()=>f});var a=t(17984);let o="lightFragment",n=`#ifdef LIGHT{X}
