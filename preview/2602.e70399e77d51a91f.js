...
#endif
`;n.l.IncludesShadersStoreWGSL[a]||(n.l.IncludesShadersStoreWGSL[a]=o),i(92412),i(64470),i(63745),i(3162),i(75185),i(81696),i(98585),i(28607),i(50221),i(92856),i(64723),i(41791),i(37506),i(43561),i(6937),i(11376),i(41086);let t="openpbrNormalMapFragmentMainFunctions",f=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;n.l.IncludesShadersStoreWGSL[t]||(n.l.IncludesShadersStoreWGSL[t]=f);let s="openpbrNormalMapFragmentFunctions",l=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;n.l.IncludesShadersStoreWGSL[s]||(n.l.IncludesShadersStoreWGSL[s]=l),i(82763);let c="openpbrDielectricReflectance",m=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;n.l.IncludesShadersStoreWGSL[c]||(n.l.IncludesShadersStoreWGSL[c]=m);let d="openpbrConductorReflectance",u=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;n.l.IncludesShadersStoreWGSL[d]||(n.l.IncludesShadersStoreWGSL[d]=u);let _="openpbrAmbientOcclusionFunctions",p=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;n.l.IncludesShadersStoreWGSL[_]||(n.l.IncludesShadersStoreWGSL[_]=p);let v="openpbrGeometryInfo",g=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;n.l.IncludesShadersStoreWGSL[v]||(n.l.IncludesShadersStoreWGSL[v]=g);let I="openpbrIblFunctions",S=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;n.l.IncludesShadersStoreWGSL[I]||(n.l.IncludesShadersStoreWGSL[I]=S),i(19456),i(35071);let E="openpbrNormalMapFragment",h=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;n.l.IncludesShadersStoreWGSL[E]||(n.l.IncludesShadersStoreWGSL[E]=h);let R="openpbrBlockNormalFinal",N=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[R]||(n.l.IncludesShadersStoreWGSL[R]=N);let T="openpbrBaseLayerData",A=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;n.l.IncludesShadersStoreWGSL[L]||(n.l.IncludesShadersStoreWGSL[L]=b);let F="openpbrCoatLayerData",C=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;n.l.IncludesShadersStoreWGSL[F]||(n.l.IncludesShadersStoreWGSL[F]=C);let O="openpbrThinFilmLayerData",D=`#ifdef THIN_FILM
...
#endif
`;n.l.IncludesShadersStoreWGSL[O]||(n.l.IncludesShadersStoreWGSL[O]=D);let M="openpbrFuzzLayerData",x=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[M]||(n.l.IncludesShadersStoreWGSL[M]=x);let G="openpbrAmbientOcclusionData",P=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;n.l.IncludesShadersStoreWGSL[G]||(n.l.IncludesShadersStoreWGSL[G]=P),i(57873);let y="openpbrBackgroundTransmission",z=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;n.l.IncludesShadersStoreWGSL[y]||(n.l.IncludesShadersStoreWGSL[y]=z);let W="openpbrEnvironmentLighting",U=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[W]||(n.l.IncludesShadersStoreWGSL[W]=U);let X="openpbrDirectLightingInit",B=`#ifdef LIGHT{X}
...
#endif
#endif
`;n.l.IncludesShadersStoreWGSL[X]||(n.l.IncludesShadersStoreWGSL[X]=B);let V="openpbrDirectLighting",H=`#ifdef LIGHT{X}
...
#endif
`;n.l.IncludesShadersStoreWGSL[V]||(n.l.IncludesShadersStoreWGSL[V]=H),i(44865),i(56044),i(75481),i(14579),i(7472),i(28473);let w="openpbrPixelShader",k=`#define OPENPBR_FRAGMENT_SHADER
...
`;n.l.ShadersStoreWGSL[w]||(n.l.ShadersStoreWGSL[w]=k);let Y={name:w,shader:k}}}]);