...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["5608"],{41238(e,i,t){t.r(i),t.d(i,{bumpFragment:()=>f});var a=t(20854);let o="bumpFragment",n=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;a.l.IncludesShadersStore[o]||(a.l.IncludesShadersStore[o]=n);let f={name:o,shader:n}},30145(e,i,t){t.r(i),t.d(i,{bumpFragmentFunctions:()=>f});var a=t(20854);t(63714);let o="bumpFragmentFunctions",n=`#if defined(BUMP)
...
#endif
`;a.l.IncludesShadersStore[o]||(a.l.IncludesShadersStore[o]=n);let f={name:o,shader:n}},57578(e,i,t){t.r(i),t.d(i,{bumpFragmentMainFunctions:()=>f});var a=t(20854);let o="bumpFragmentMainFunctions",n=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#ifdef OBJECTSPACE_NORMALMAP
...
#endif
`;a.l.IncludesShadersStore[o]||(a.l.IncludesShadersStore[o]=n);let f={name:o,shader:n}},25802(e,i,t){var a=t(20854);let o="clusteredLightingFunctions",n=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;a.l.IncludesShadersStore[o]||(a.l.IncludesShadersStore[o]=n)},96433(e,i,t){var a=t(20854);let o="decalFragment",n=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;a.l.IncludesShadersStore[o]||(a.l.IncludesShadersStore[o]=n)},68708(e,i,t){t.r(i),t.d(i,{lightFragment:()=>f});var a=t(20854);let o="lightFragment",n=`#ifdef LIGHT{X}
