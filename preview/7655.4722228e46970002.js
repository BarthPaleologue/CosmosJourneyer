"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["7655"],{61141:function(e,i,t){var o=t(22081);t(60613);let n="backgroundUboDeclaration",f=`layout(std140,column_major) uniform;uniform Material
...
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f)},27377:function(e,i,t){var o=t(22081);let n="clusteredLightingFunctions",f=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f)},28901:function(e,i,t){t.r(i),t.d(i,{lightFragment:()=>l});var o=t(22081);let n="lightFragment",f=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f);let l={name:n,shader:f}},57823:function(e,i,t){t.r(i),t.d(i,{lightsFragmentFunctions:()=>l});var o=t(22081);t(31503),t(27377);let n="lightsFragmentFunctions",f=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f);let l={name:n,shader:f}},28042:function(e,i,t){t.r(i),t.d(i,{backgroundPixelShader:()=>d});var o=t(22081);let n="backgroundFragmentDeclaration",f=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
uniform vec2 projectedGroundInfos;
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f),t(61141),t(17796),t(98252),t(96563),t(18189),t(71681),t(57823),t(48027),t(5762),t(36036),t(30557),t(30337);let l="intersectionFunctions",r=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;o.l.IncludesShadersStore[l]||(o.l.IncludesShadersStore[l]=r),t(46741),t(28901),t(18170),t(45857);let a="backgroundPixelShader",s=`#ifdef TEXTURELODSUPPORT
