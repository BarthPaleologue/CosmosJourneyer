"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["323"],{12876:function(e,t,o){var a=o(34981);let i="hdrFilteringFunctions",n=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;a.l.IncludesShadersStore[i]||(a.l.IncludesShadersStore[i]=n)},89758:function(e,t,o){var a=o(34981);let i="importanceSampling",n=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;a.l.IncludesShadersStore[i]||(a.l.IncludesShadersStore[i]=n)},97914:function(e,t,o){var a=o(34981);let i="pbrBRDFFunctions",n=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;a.l.IncludesShadersStore[i]||(a.l.IncludesShadersStore[i]=n)},22494:function(e,t,o){o.r(t),o.d(t,{iblDominantDirectionPixelShader:()=>l});var a=o(34981);o(13384),o(89758),o(97914),o(12876);let i="iblDominantDirectionPixelShader",n=`precision highp sampler2D;precision highp samplerCube;
