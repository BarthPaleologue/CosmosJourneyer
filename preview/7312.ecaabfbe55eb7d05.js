...
`;a.l.IncludesShadersStore[r]||(a.l.IncludesShadersStore[r]=f),n(98242),n(5512),n(1008),n(12966),n(99188);let o="samplerFragmentAlternateDeclaration",t=`#ifdef _DEFINENAME_
...
#endif
`;a.l.IncludesShadersStore[c]||(a.l.IncludesShadersStore[c]=l),n(37318),n(67888),n(29343),n(99048),n(68595),n(86402),n(39743),n(82069),n(80655),n(24018),n(79121),n(90493),n(86164),n(43119),n(94011),n(19798),n(12216),n(41816),n(16043),n(27413),n(56163);let d="pbrBlockAlbedoOpacity",s=`struct albedoOpacityOutParams
...
return outParams;}
#endif
`;a.l.IncludesShadersStore[D]||(a.l.IncludesShadersStore[D]=h),n(61348);let F="pbrBlockReflectance0",g=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
...
return result;}
#endif
`;a.l.IncludesShadersStore[P]||(a.l.IncludesShadersStore[P]=U),n(13030),n(34801),n(82788);let b="pbrBlockNormalFinal",y=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;a.l.IncludesShadersStore[b]||(a.l.IncludesShadersStore[b]=y),n(64871);let B="pbrBlockLightmapInit",G=`#ifdef LIGHTMAP
...
#endif
`;a.l.IncludesShadersStore[Y]||(a.l.IncludesShadersStore[Y]=k),n(65446);let X="pbrBlockFinalLitComponents",w=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
`;a.l.IncludesShadersStore[Z]||(a.l.IncludesShadersStore[Z]=q),n(87235),n(42990),n(52511),n(66941),n(74050),n(40395);let J="pbrPixelShader",j=`#define PBR_FRAGMENT_SHADER
