...
#endif
`;i.l.IncludesShadersStoreWGSL[o]||(i.l.IncludesShadersStoreWGSL[o]=n),a(34039),a(70217),a(74456),a(38677),a(80352),a(93549),a(8057),a(6688),a(14358),a(32335),a(93344),a(81590),a(69539),a(63458),a(20180),a(33895),a(30243);let t="openpbrNormalMapFragmentMainFunctions",f=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;i.l.IncludesShadersStoreWGSL[l]||(i.l.IncludesShadersStoreWGSL[l]=c),a(48e3);let s="openpbrDielectricReflectance",m=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;i.l.IncludesShadersStoreWGSL[s]||(i.l.IncludesShadersStoreWGSL[s]=m);let d="openpbrConductorReflectance",u=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;i.l.IncludesShadersStoreWGSL[d]||(i.l.IncludesShadersStoreWGSL[d]=u);let p="openpbrBlockAmbientOcclusion",g=`struct ambientOcclusionOutParams
...
`;i.l.IncludesShadersStoreWGSL[p]||(i.l.IncludesShadersStoreWGSL[p]=g);let v="openpbrGeometryInfo",_=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
#endif
`;i.l.IncludesShadersStoreWGSL[v]||(i.l.IncludesShadersStoreWGSL[v]=_);let I="openpbrIblFunctions",S=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;i.l.IncludesShadersStoreWGSL[I]||(i.l.IncludesShadersStoreWGSL[I]=S),a(47417),a(72018);let E="openpbrNormalMapFragment",h=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;i.l.IncludesShadersStoreWGSL[E]||(i.l.IncludesShadersStoreWGSL[E]=h);let R="openpbrBlockNormalFinal",N=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;i.l.IncludesShadersStoreWGSL[A]||(i.l.IncludesShadersStoreWGSL[A]=L);let T="openpbrCoatLayerData",O=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;i.l.IncludesShadersStoreWGSL[T]||(i.l.IncludesShadersStoreWGSL[T]=O);let b="openpbrThinFilmLayerData",F=`#ifdef THIN_FILM
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[b]||(i.l.IncludesShadersStoreWGSL[b]=F),a(84446);let C="openpbrEnvironmentLighting",M=`#ifdef REFLECTION
...
#endif
`;i.l.IncludesShadersStoreWGSL[C]||(i.l.IncludesShadersStoreWGSL[C]=M);let D="openpbrDirectLightingInit",x=`#ifdef LIGHT{X}
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[D]||(i.l.IncludesShadersStoreWGSL[D]=x);let G="openpbrDirectLighting",P=`#ifdef LIGHT{X}
...
#endif
`;i.l.IncludesShadersStoreWGSL[G]||(i.l.IncludesShadersStoreWGSL[G]=P),a(30438),a(71805),a(66484),a(9002),a(84597),a(16510);let y="openpbrPixelShader",W=`#define OPENPBR_FRAGMENT_SHADER
...
`;i.l.ShadersStoreWGSL[y]||(i.l.ShadersStoreWGSL[y]=W);let X={name:y,shader:W}}}]);