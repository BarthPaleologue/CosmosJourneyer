...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=o),a(71196),a(5430),a(91873),a(85402),a(29969),a(76672),a(58361),a(94655),a(18125),a(984),a(32627),a(32063),a(93154),a(15945),a(6777),a(7632),a(76702);let t="openpbrNormalMapFragmentMainFunctions",f=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;i.l.IncludesShadersStoreWGSL[l]||(i.l.IncludesShadersStoreWGSL[l]=c),a(71499);let s="openpbrDielectricReflectance",m=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
#endif
`;i.l.IncludesShadersStoreWGSL[I]||(i.l.IncludesShadersStoreWGSL[I]=S),a(40128),a(59391);let h="openpbrNormalMapFragment",E=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[C]||(i.l.IncludesShadersStoreWGSL[C]=M),a(15953);let D="openpbrEnvironmentLighting",x=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
`;i.l.IncludesShadersStoreWGSL[P]||(i.l.IncludesShadersStoreWGSL[P]=y),a(40513),a(99756),a(26745),a(69491),a(86576),a(74809);let W="openpbrPixelShader",U=`#define OPENPBR_FRAGMENT_SHADER
