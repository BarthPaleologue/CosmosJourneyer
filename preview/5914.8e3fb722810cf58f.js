...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["5914"],{81088:function(e,a,r){r.r(a),r.d(a,{bumpFragmentWGSL:()=>t});var i=r(22081);let n="bumpFragment",f=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},68703:function(e,a,r){r.r(a),r.d(a,{bumpFragmentFunctionsWGSL:()=>t});var i=r(22081);r(62376);let n="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},81276:function(e,a,r){r.r(a),r.d(a,{bumpFragmentMainFunctionsWGSL:()=>t});var i=r(22081);let n="bumpFragmentMainFunctions",f=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=f);let t="pbrFragmentSamplersDeclaration",o=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;i.l.IncludesShadersStoreWGSL[t]||(i.l.IncludesShadersStoreWGSL[t]=o),r(36650),r(51644),r(67827),r(39580),r(41647),r(1502),r(7779),r(86713),r(94323),r(66998),r(23365),r(95193),r(74632),r(13435),r(62919),r(642),r(49460),r(81276),r(68703),r(65033),r(12127);let c="pbrBlockAlbedoOpacity",l=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;i.l.IncludesShadersStoreWGSL[c]||(i.l.IncludesShadersStoreWGSL[c]=l);let d="pbrBlockReflectivity",s=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;i.l.IncludesShadersStoreWGSL[d]||(i.l.IncludesShadersStoreWGSL[d]=s);let m="pbrBlockAmbientOcclusion",E=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;i.l.IncludesShadersStoreWGSL[m]||(i.l.IncludesShadersStoreWGSL[m]=E);let S="pbrBlockAlphaFresnel",R=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[S]||(i.l.IncludesShadersStoreWGSL[S]=R);let v="pbrBlockAnisotropic",u=`#ifdef ANISOTROPIC
...
#endif
`;i.l.IncludesShadersStoreWGSL[v]||(i.l.IncludesShadersStoreWGSL[v]=u);let p="pbrBlockReflection",C=`#ifdef REFLECTION
...
#endif
`;i.l.IncludesShadersStoreWGSL[p]||(i.l.IncludesShadersStoreWGSL[p]=C);let A="pbrBlockSheen",I=`#ifdef SHEEN
...
#endif
`;i.l.IncludesShadersStoreWGSL[A]||(i.l.IncludesShadersStoreWGSL[A]=I);let N="pbrBlockClearcoat",O=`struct clearcoatOutParams
...
return outParams;}
#endif
`;i.l.IncludesShadersStoreWGSL[N]||(i.l.IncludesShadersStoreWGSL[N]=O);let T="pbrBlockIridescence",L=`struct iridescenceOutParams
...
#endif
`;i.l.IncludesShadersStoreWGSL[T]||(i.l.IncludesShadersStoreWGSL[T]=L);let _="pbrBlockSubSurface",M=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;i.l.IncludesShadersStoreWGSL[_]||(i.l.IncludesShadersStoreWGSL[_]=M),r(69226),r(10917),r(81088);let D="pbrBlockNormalFinal",F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[D]||(i.l.IncludesShadersStoreWGSL[D]=F),r(95987);let g="pbrBlockLightmapInit",h=`#ifdef LIGHTMAP
...
#endif
`;i.l.IncludesShadersStoreWGSL[g]||(i.l.IncludesShadersStoreWGSL[g]=h);let P="pbrBlockGeometryInfo",b=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[P]||(i.l.IncludesShadersStoreWGSL[P]=b),r(30455);let U="pbrBlockReflectance",B=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[U]||(i.l.IncludesShadersStoreWGSL[U]=B);let y="pbrBlockDirectLighting",x=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;i.l.IncludesShadersStoreWGSL[y]||(i.l.IncludesShadersStoreWGSL[y]=x),r(45346);let G="pbrBlockFinalLitComponents",V=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[G]||(i.l.IncludesShadersStoreWGSL[G]=V);let H="pbrBlockFinalUnlitComponents",W=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;i.l.IncludesShadersStoreWGSL[H]||(i.l.IncludesShadersStoreWGSL[H]=W);let Y="pbrBlockFinalColorComposition",k=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;i.l.IncludesShadersStoreWGSL[Y]||(i.l.IncludesShadersStoreWGSL[Y]=k),r(23199),r(36362),r(69691),r(27209),r(51414),r(16599);let X="pbrPixelShader",w=`#define PBR_FRAGMENT_SHADER
...
`;i.l.ShadersStoreWGSL[X]||(i.l.ShadersStoreWGSL[X]=w);let z={name:X,shader:w}}}]);