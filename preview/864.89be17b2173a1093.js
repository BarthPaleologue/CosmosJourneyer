...
`;n.l.IncludesShadersStore[a]||(n.l.IncludesShadersStore[a]=t),i(32482),i(10012),i(40164),i(83858),i(60059);let r="openpbrFragmentSamplersDeclaration",l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;n.l.IncludesShadersStore[r]||(n.l.IncludesShadersStore[r]=l),i(62762),i(18300),i(60243),i(97340),i(41007),i(79646),i(19075),i(57497),i(90131),i(39094),i(94917),i(70745),i(67080),i(4219),i(64967),i(226),i(42932);let f="openpbrNormalMapFragmentMainFunctions",c=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;n.l.IncludesShadersStore[s]||(n.l.IncludesShadersStore[s]=d),i(70121);let m="openpbrDielectricReflectance",u=`struct ReflectanceParams
...
#endif
`;n.l.IncludesShadersStore[h]||(n.l.IncludesShadersStore[h]=R),i(42794),i(95365);let N="openpbrNormalMapFragment",A=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
#endif
`;n.l.IncludesShadersStore[M]||(n.l.IncludesShadersStore[M]=P),i(86259);let G="openpbrEnvironmentLighting",z=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
`;n.l.IncludesShadersStore[U]||(n.l.IncludesShadersStore[U]=W),i(62975),i(86826),i(95291),i(8425),i(44950),i(79191);let X="openpbrPixelShader",B=`#define OPENPBR_FRAGMENT_SHADER
