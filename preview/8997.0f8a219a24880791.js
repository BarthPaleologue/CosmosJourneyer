...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["8997"],{62946(e,r,t){var o=t(56863);let a="clusteredLightingFunctions",i=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
...
`;o.l.IncludesShadersStoreWGSL[a]||(o.l.IncludesShadersStoreWGSL[a]=i)},92412(e,r,t){t.r(r),t.d(r,{imageProcessingDeclarationWGSL:()=>f});var o=t(56863);let a="imageProcessingDeclaration",i=`#ifdef EXPOSURE
...
#endif
`;o.l.IncludesShadersStoreWGSL[a]||(o.l.IncludesShadersStoreWGSL[a]=i);let f={name:a,shader:i}},50221(e,r,t){t.r(r),t.d(r,{imageProcessingFunctionsWGSL:()=>f});var o=t(56863);let a="imageProcessingFunctions",i=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;o.l.IncludesShadersStoreWGSL[a]||(o.l.IncludesShadersStoreWGSL[a]=i);let f={name:a,shader:i}},59556(e,r,t){t.r(r),t.d(r,{lightUboDeclarationWGSL:()=>f});var o=t(56863);let a="lightUboDeclaration",i=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
...
#endif
#endif
`;o.l.IncludesShadersStoreWGSL[a]||(o.l.IncludesShadersStoreWGSL[a]=i);let f={name:a,shader:i}},65840(e,r,t){var o=t(56863);let a="ltcHelperFunctions",i=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;o.l.IncludesShadersStoreWGSL[a]||(o.l.IncludesShadersStoreWGSL[a]=i)},82763(e,r,t){t.r(r),t.d(r,{reflectionFunctionWGSL:()=>f});var o=t(56863);let a="reflectionFunction",i=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;o.l.IncludesShadersStoreWGSL[a]||(o.l.IncludesShadersStoreWGSL[a]=i);let f={name:a,shader:i}},92856(e,r,t){t.r(r),t.d(r,{shadowsFragmentFunctionsWGSL:()=>f});var o=t(56863);let a="shadowsFragmentFunctions",i=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;o.l.IncludesShadersStoreWGSL[a]||(o.l.IncludesShadersStoreWGSL[a]=i);let f={name:a,shader:i}}}]);