...
"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["3070"],{2513:function(e,r,a){a.r(r),a.d(r,{bumpFragmentWGSL:()=>t});var i=a(38700);let f="bumpFragment",n=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n);let t={name:f,shader:n}},31963:function(e,r,a){a.r(r),a.d(r,{bumpFragmentFunctionsWGSL:()=>t});var i=a(38700);a(54317);let f="bumpFragmentFunctions",n=`#if defined(BUMP)
...
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n);let t={name:f,shader:n}},63747:function(e,r,a){a.r(r),a.d(r,{bumpFragmentMainFunctionsWGSL:()=>t});var i=a(38700);let f="bumpFragmentMainFunctions",n=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
...
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n);let t={name:f,shader:n}},23514:function(e,r,a){var i=a(38700);let f="depthPrePass",n=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n)},26964:function(e,r,a){var i=a(38700);let f="harmonicsFunctions",n=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n)},49200:function(e,r,a){var i=a(38700);let f="hdrFilteringFunctions",n=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n)},60490:function(e,r,a){var i=a(38700);let f="importanceSampling",n=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDggx(u: vec2f,a: f32)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDCharlie(u: vec2f,a: f32)->vec3f { 
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n)},33803:function(e,r,a){var i=a(38700);let f="mainUVVaryingDeclaration",n=`#ifdef MAINUV{X}
varying vMainUV{X}: vec2f;
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n)},33801:function(e,r,a){var i=a(38700);let f="oitDeclaration",n=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n)},12153:function(e,r,a){var i=a(38700);let f="oitFragment",n=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n)},19822:function(e,r,a){var i=a(38700);let f="pbrBRDFFunctions",n=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n)},54317:function(e,r,a){var i=a(38700);let f="samplerFragmentDeclaration",n=`#ifdef _DEFINENAME_
...
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n)},87417:function(e,r,a){var i=a(38700);let f="subSurfaceScatteringFunctions",n=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n)},3389:function(e,r,a){a.r(r),a.d(r,{pbrPixelShaderWGSL:()=>em});var i=a(38700);a(13101),a(33801),a(83237),a(33803);let f="pbrFragmentExtraDeclaration",n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;i.l.IncludesShadersStoreWGSL[f]||(i.l.IncludesShadersStoreWGSL[f]=n),a(87065),a(54317);let t="samplerFragmentAlternateDeclaration",o=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
`;i.l.IncludesShadersStoreWGSL[c]||(i.l.IncludesShadersStoreWGSL[c]=l),a(97227),a(87941),a(8588),a(88249),a(92828),a(87417),a(60490);let s="pbrHelperFunctions",d=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;i.l.IncludesShadersStoreWGSL[s]||(i.l.IncludesShadersStoreWGSL[s]=d),a(44634),a(12579),a(26964),a(81863);let E="pbrDirectLightingSetupFunctions",v=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
}`;i.l.IncludesShadersStoreWGSL[m]||(i.l.IncludesShadersStoreWGSL[m]=u),a(19822),a(49200),a(5657);let S="pbrBlockReflectance0",R=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;i.l.IncludesShadersStoreWGSL[A]||(i.l.IncludesShadersStoreWGSL[A]=I),a(63747),a(31963),a(68916),a(20696);let N="pbrBlockAlbedoOpacity",L=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
return outParams;}
#endif
`;i.l.IncludesShadersStoreWGSL[H]||(i.l.IncludesShadersStoreWGSL[H]=W),a(45677);let Y="pbrBlockNormalGeometric",w=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;i.l.IncludesShadersStoreWGSL[Y]||(i.l.IncludesShadersStoreWGSL[Y]=w),a(2513);let X="pbrBlockNormalFinal",k=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[X]||(i.l.IncludesShadersStoreWGSL[X]=k),a(23514);let z="pbrBlockLightmapInit",K=`#ifdef LIGHTMAP
...
#endif
`;i.l.IncludesShadersStoreWGSL[Q]||(i.l.IncludesShadersStoreWGSL[Q]=$),a(16365);let ee="pbrBlockFinalLitComponents",er=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
`;i.l.IncludesShadersStoreWGSL[ef]||(i.l.IncludesShadersStoreWGSL[ef]=en),a(114),a(81993);let et="pbrBlockImageProcessing",eo=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[ec]||(i.l.IncludesShadersStoreWGSL[ec]=el),a(12153);let es="pbrDebug",ed=`#if DEBUGMODE>0
