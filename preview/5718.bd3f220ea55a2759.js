"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["5718"],{77621(e,r,f){f.r(r),f.d(r,{iblCdfDebugPixelShaderWGSL:()=>a});var c=f(20854);let t="iblCdfDebugPixelShader",i=`#define PI 3.1415927
...
fragmentOutputs.color =vec4(mix(colour,backgroundColour,0.5),1.0);}`;c.l.ShadersStoreWGSL[t]||(c.l.ShadersStoreWGSL[t]=i);let a={name:t,shader:i}}}]);