"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["5503"],{23919:function(e,i,t){var o=t(68415);t(44243);let n="backgroundUboDeclaration",f=`layout(std140,column_major) uniform;uniform Material
...
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f)},84959:function(e,i,t){var o=t(68415);let n="clusteredLightingFunctions",f=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f)},66515:function(e,i,t){t.r(i),t.d(i,{lightFragment:()=>l});var o=t(68415);let n="lightFragment",f=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f);let l={name:n,shader:f}},22649:function(e,i,t){t.r(i),t.d(i,{lightsFragmentFunctions:()=>l});var o=t(68415);t(9709),t(84959);let n="lightsFragmentFunctions",f=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f);let l={name:n,shader:f}},54098:function(e,i,t){t.r(i),t.d(i,{backgroundPixelShader:()=>d});var o=t(68415);let n="backgroundFragmentDeclaration",f=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
uniform vec2 projectedGroundInfos;
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f),t(23919),t(34450),t(94538),t(62097),t(91055),t(35239),t(22649),t(39505),t(9704),t(20142),t(71531),t(27115);let l="intersectionFunctions",r=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;o.l.IncludesShadersStore[l]||(o.l.IncludesShadersStore[l]=r),t(32887),t(66515),t(88040),t(93911);let a="backgroundPixelShader",s=`#ifdef TEXTURELODSUPPORT
