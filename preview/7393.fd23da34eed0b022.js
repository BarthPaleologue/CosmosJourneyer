"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["7393"],{99024:function(e,i,o){var t=o(38700);o(81662);let l="backgroundUboDeclaration",n=`layout(std140,column_major) uniform;uniform Material
...
`;t.l.IncludesShadersStore[l]||(t.l.IncludesShadersStore[l]=n)},79600:function(e,i,o){o.r(i),o.d(i,{lightsFragmentFunctions:()=>r});var t=o(38700);o(78814),o(37912);let l="lightsFragmentFunctions",n=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;t.l.IncludesShadersStore[l]||(t.l.IncludesShadersStore[l]=n);let r={name:l,shader:n}},2456:function(e,i,o){o.r(i),o.d(i,{backgroundPixelShader:()=>s});var t=o(38700);let l="backgroundFragmentDeclaration",n=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
uniform vec2 projectedGroundInfos;
#endif
`;t.l.IncludesShadersStore[l]||(t.l.IncludesShadersStore[l]=n),o(99024),o(66207),o(85721),o(14266),o(93620),o(44258),o(79600),o(79110),o(64163),o(62883),o(48268),o(10540);let r="intersectionFunctions",f=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;t.l.IncludesShadersStore[r]||(t.l.IncludesShadersStore[r]=f),o(46394),o(64178),o(53039),o(56154);let a="backgroundPixelShader",c=`#ifdef TEXTURELODSUPPORT
