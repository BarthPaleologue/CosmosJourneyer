"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["583"],{49200:function(e,f,r){var a=r(38700);let t="hdrFilteringFunctions",n=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif 
`;a.l.IncludesShadersStoreWGSL[t]||(a.l.IncludesShadersStoreWGSL[t]=n)},27213:function(e,f,r){r.r(f),r.d(f,{iblDominantDirectionPixelShaderWGSL:()=>i});var a=r(38700);r(92828),r(60490),r(19822),r(49200);let t="iblDominantDirectionPixelShader",n=`#include<helperFunctions>
...
lightDir/=vec3f(f32(NUM_SAMPLES));fragmentOutputs.color=vec4f(lightDir,1.0);}`;a.l.ShadersStoreWGSL[t]||(a.l.ShadersStoreWGSL[t]=n);let i={name:t,shader:n}}}]);