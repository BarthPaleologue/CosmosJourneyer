...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["5109"],{71073(e,a,r){r.r(a),r.d(a,{bumpFragmentWGSL:()=>t});var i=r(77948);let n="bumpFragment",f=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},37848(e,a,r){r.r(a),r.d(a,{bumpFragmentFunctionsWGSL:()=>t});var i=r(77948);r(10493);let n="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},3571(e,a,r){r.r(a),r.d(a,{bumpFragmentMainFunctionsWGSL:()=>t});var i=r(77948);let n="bumpFragmentMainFunctions",f=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
...
#endif
`;i.l.IncludesShadersStoreWGSL[t]||(i.l.IncludesShadersStoreWGSL[t]=o),r(76251),r(98997),r(84444),r(21161),r(22636),r(78665),r(77146),r(6372),r(98186),r(45747),r(68004),r(13570),r(63911),r(99550),r(1888),r(93635),r(52719),r(3571),r(37848),r(70884),r(73352);let c="pbrBlockAlbedoOpacity",l=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
return outParams;}
#endif
`;i.l.IncludesShadersStoreWGSL[_]||(i.l.IncludesShadersStoreWGSL[_]=M),r(82589),r(89958),r(71073);let D="pbrBlockNormalFinal",F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[D]||(i.l.IncludesShadersStoreWGSL[D]=F),r(48106);let g="pbrBlockLightmapInit",h=`#ifdef LIGHTMAP
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[P]||(i.l.IncludesShadersStoreWGSL[P]=b),r(42754);let U="pbrBlockReflectance",B=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
`;i.l.IncludesShadersStoreWGSL[y]||(i.l.IncludesShadersStoreWGSL[y]=x),r(39133);let G="pbrBlockFinalLitComponents",V=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
`;i.l.IncludesShadersStoreWGSL[Y]||(i.l.IncludesShadersStoreWGSL[Y]=k),r(12194),r(87641),r(56464),r(73350),r(45577),r(59802);let X="pbrPixelShader",w=`#define PBR_FRAGMENT_SHADER
