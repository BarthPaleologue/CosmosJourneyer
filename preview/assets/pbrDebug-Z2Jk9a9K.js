import{n as e}from"./chunk-Cyuzqnbw.js";import{n as t,t as n}from"./shaderStore-DR7YeKlK.js";import{t as r}from"./clusteredLightingFunctions-BgbGP3-d.js";import{t as i}from"./ltcHelperFunctions-DYx-ZVCt.js";import{t as a}from"./mainUVVaryingDeclaration-D5E1MqYL.js";var o,s,c=e((()=>{t(),a(),o=`pbrFragmentExtraDeclaration`,s=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`,n.IncludesShadersStoreWGSL[o]||(n.IncludesShadersStoreWGSL[o]=s)})),l,u,d=e((()=>{t(),l=`subSurfaceScatteringFunctions`,u=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`,n.IncludesShadersStoreWGSL[l]||(n.IncludesShadersStoreWGSL[l]=u)})),f,p,m=e((()=>{t(),f=`pbrHelperFunctions`,p=`#define MINIMUMVARIANCE 0.0005
...
#endif
`,n.IncludesShadersStoreWGSL[f]||(n.IncludesShadersStoreWGSL[f]=p)})),h,g,_=e((()=>{t(),i(),h=`pbrDirectLightingSetupFunctions`,g=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`,n.IncludesShadersStoreWGSL[h]||(n.IncludesShadersStoreWGSL[h]=g)})),v,y,b=e((()=>{t(),v=`pbrDirectLightingFalloffFunctions`,y=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`,n.IncludesShadersStoreWGSL[v]||(n.IncludesShadersStoreWGSL[v]=y)})),x,S,C=e((()=>{t(),x=`pbrBlockReflectance0`,S=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`,n.IncludesShadersStoreWGSL[x]||(n.IncludesShadersStoreWGSL[x]=S)})),w,T,E=e((()=>{t(),r(),C(),w=`pbrDirectLightingFunctions`,T=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`,n.IncludesShadersStoreWGSL[w]||(n.IncludesShadersStoreWGSL[w]=T)})),D,O,k=e((()=>{t(),D=`pbrIBLFunctions`,O=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`,n.IncludesShadersStoreWGSL[D]||(n.IncludesShadersStoreWGSL[D]=O)})),A,j,M=e((()=>{t(),A=`pbrBlockNormalGeometric`,j=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`,n.IncludesShadersStoreWGSL[A]||(n.IncludesShadersStoreWGSL[A]=j)})),N,P,F=e((()=>{t(),N=`pbrBlockImageProcessing`,P=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`,n.IncludesShadersStoreWGSL[N]||(n.IncludesShadersStoreWGSL[N]=P)})),I,L,R=e((()=>{t(),I=`pbrBlockPrePass`,L=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[I]||(n.IncludesShadersStoreWGSL[I]=L)})),z,B,V=e((()=>{t(),z=`pbrDebug`,B=`#if DEBUGMODE>0
...
//# sourceMappingURL=pbrDebug-Z2Jk9a9K.js.map