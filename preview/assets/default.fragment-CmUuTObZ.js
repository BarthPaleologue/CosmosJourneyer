...
`);const n=`lightsFragmentFunctions`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`);const r=`fresnelFunction`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`);const i=`defaultPixelShader`,a=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=a);const o={name:i,shader:a};export{o as defaultPixelShader};