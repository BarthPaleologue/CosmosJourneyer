import{t as e}from"./shaderStore-D-XQlhUT.js";const t=`sceneUboDeclaration`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=`layout(std140,column_major) uniform;uniform Scene {mat4 viewProjection;
#ifdef MULTIVIEW
...
#endif
#endif
`);const s=`pbrBRDFFunctions`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif 
`);
//# sourceMappingURL=pbrBRDFFunctions-D7GGIWNk.js.map