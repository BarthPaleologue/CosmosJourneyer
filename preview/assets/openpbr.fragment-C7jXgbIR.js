import{n as e}from"./chunk-Cyuzqnbw.js";import{n as t,t as n}from"./shaderStore-DR7YeKlK.js";import{n as ee}from"./helperFunctions-Dv88wD2h.js";import{n as te}from"./clipPlaneFragmentDeclaration-BjnOaHEy.js";import{t as ne}from"./logDepthDeclaration-CePzDkyG.js";import{n as re}from"./fogFragmentDeclaration-CUdxThAV.js";import{t as ie}from"./logDepthFragment-DrsGQlzY.js";import{t as ae}from"./fogFragment-DyC7Abjg.js";import{n as oe}from"./clipPlaneFragment-BDIjmn0N.js";import{t as se}from"./reflectionFunction-CX-6LeJj.js";import{n as ce}from"./imageProcessingDeclaration-CLTJjnxq.js";import{t as r}from"./lightFragmentDeclaration-aB72VJiS.js";import{t as i}from"./lightUboDeclaration-D0tQ2g08.js";import{t as a}from"./shadowsFragmentFunctions-DPKgBXmm.js";import{n as le}from"./imageProcessingFunctions-C9H-h1Xs.js";import{t as ue}from"./pbrBRDFFunctions-VhVcK8yq.js";import{t as de}from"./harmonicsFunctions-p_9_fmHa.js";import{a as fe,i as pe,n as me,r as he,t as ge}from"./oitFragment-BsUYK0Rr.js";import{a as _e,c as ve,d as ye,i as be,l as xe,n as Se,o as Ce,r as we,s as Te,t as Ee,u as De}from"./pbrDebug-B_-IJO2L.js";import{t as o}from"./samplerFragmentDeclaration-vMxbLxgk.js";import{n as Oe,t as ke}from"./hdrFilteringFunctions-Bt0Z2iiv.js";import{t as Ae}from"./openpbrUboDeclaration-D7CtNnn7.js";import{t as je}from"./sceneFragmentDeclaration-mA1tIN0j.js";var s,c,Me=e((()=>{t(),je(),he(),s=`openpbrFragmentDeclaration`,c=`uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vTransmissionWeight;uniform vec3 vTransmissionColor;uniform float vTransmissionDepth;uniform vec3 vTransmissionScatter;uniform float vTransmissionScatterAnisotropy;uniform float vTransmissionDispersionScale;uniform float vTransmissionDispersionAbbeNumber;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform float vGeometryThickness;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform vec4 vLightingIntensity;uniform float visibility;
#ifdef BASE_COLOR
...
`,n.IncludesShadersStore[s]||(n.IncludesShadersStore[s]=c)})),l,u,Ne=e((()=>{t(),o(),l=`openpbrFragmentSamplersDeclaration`,u=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`,n.IncludesShadersStore[l]||(n.IncludesShadersStore[l]=u)})),d,f,Pe=e((()=>{t(),d=`openpbrNormalMapFragmentMainFunctions`,f=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`,n.IncludesShadersStore[d]||(n.IncludesShadersStore[d]=f)})),p,m,Fe=e((()=>{t(),o(),p=`openpbrNormalMapFragmentFunctions`,m=`#if defined(GEOMETRY_NORMAL)
...
#endif
`,n.IncludesShadersStore[p]||(n.IncludesShadersStore[p]=m)})),h,g,_=e((()=>{t(),h=`openpbrDielectricReflectance`,g=`struct ReflectanceParams
...
`,n.IncludesShadersStore[h]||(n.IncludesShadersStore[h]=g)})),v,y,Ie=e((()=>{t(),v=`openpbrConductorReflectance`,y=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`,n.IncludesShadersStore[v]||(n.IncludesShadersStore[v]=y)})),b,x,S=e((()=>{t(),b=`openpbrAmbientOcclusionFunctions`,x=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`,n.IncludesShadersStore[b]||(n.IncludesShadersStore[b]=x)})),C,w,Le=e((()=>{t(),C=`openpbrGeometryInfo`,w=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`,n.IncludesShadersStore[C]||(n.IncludesShadersStore[C]=w)})),T,E,Re=e((()=>{t(),T=`openpbrIblFunctions`,E=`#ifdef REFLECTION
...
#endif
`,n.IncludesShadersStore[T]||(n.IncludesShadersStore[T]=E)})),D,O,ze=e((()=>{t(),D=`openpbrNormalMapFragment`,O=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`,n.IncludesShadersStore[D]||(n.IncludesShadersStore[D]=O)})),k,A,Be=e((()=>{t(),k=`openpbrBlockNormalFinal`,A=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`,n.IncludesShadersStore[k]||(n.IncludesShadersStore[k]=A)})),j,M,Ve=e((()=>{t(),j=`openpbrBaseLayerData`,M=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`,n.IncludesShadersStore[N]||(n.IncludesShadersStore[N]=P)})),F,I,Ue=e((()=>{t(),F=`openpbrCoatLayerData`,I=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`,n.IncludesShadersStore[F]||(n.IncludesShadersStore[F]=I)})),L,R,We=e((()=>{t(),L=`openpbrThinFilmLayerData`,R=`#ifdef THIN_FILM
...
#endif
`,n.IncludesShadersStore[L]||(n.IncludesShadersStore[L]=R)})),z,B,Ge=e((()=>{t(),z=`openpbrFuzzLayerData`,B=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`,n.IncludesShadersStore[z]||(n.IncludesShadersStore[z]=B)})),V,H,Ke=e((()=>{t(),V=`openpbrAmbientOcclusionData`,H=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`,n.IncludesShadersStore[V]||(n.IncludesShadersStore[V]=H)})),U,W,qe=e((()=>{t(),U=`openpbrBackgroundTransmission`,W=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`,n.IncludesShadersStore[U]||(n.IncludesShadersStore[U]=W)})),G,K,Je=e((()=>{t(),G=`openpbrEnvironmentLighting`,K=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`,n.IncludesShadersStore[G]||(n.IncludesShadersStore[G]=K)})),q,J,Ye=e((()=>{t(),q=`openpbrDirectLightingInit`,J=`#ifdef LIGHT{X}
...
#endif
#endif
`,n.IncludesShadersStore[q]||(n.IncludesShadersStore[q]=J)})),Y,X,Xe=e((()=>{t(),Y=`openpbrDirectLighting`,X=`#ifdef LIGHT{X}
...
#endif
`,n.IncludesShadersStore[Y]||(n.IncludesShadersStore[Y]=X)})),Z,Q,$,Ze=e((()=>{t(),fe(),pe(),Me(),Ae(),ye(),r(),i(),Ne(),ce(),te(),ne(),re(),ee(),De(),Oe(),xe(),le(),a(),de(),ve(),Te(),ue(),ke(),Ce(),_e(),Pe(),Fe(),se(),_(),Ie(),S(),Le(),Re(),oe(),be(),ze(),Be(),Ve(),He(),Ue(),We(),Ge(),Ke(),me(),qe(),Je(),Ye(),Xe(),ie(),ae(),we(),Se(),ge(),Ee(),Z=`openpbrPixelShader`,Q=`#define OPENPBR_FRAGMENT_SHADER
...
`,n.ShadersStore[Z]||(n.ShadersStore[Z]=Q),$={name:Z,shader:Q}}));export{$ as n,Ze as t};
//# sourceMappingURL=openpbr.fragment-C7jXgbIR.js.map