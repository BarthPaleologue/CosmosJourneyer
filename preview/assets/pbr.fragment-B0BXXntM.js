import{n as e}from"./chunk-Cyuzqnbw.js";import{n as t,t as n}from"./shaderStore-DR7YeKlK.js";import{n as ee}from"./helperFunctions-DxRVZtIm.js";import{t as te}from"./decalFragment-Bhkr_c_r.js";import{n as ne}from"./clipPlaneFragmentDeclaration-Das-drhD.js";import{t as re}from"./logDepthDeclaration-C-yUb1nt.js";import{n as r}from"./fogFragmentDeclaration-CTXnVo1a.js";import{t as i}from"./logDepthFragment-DpQZNVQF.js";import{t as a}from"./fogFragment-B8UcrDCQ.js";import{n as o}from"./clipPlaneFragment-BRFbw7xV.js";import{t as s}from"./reflectionFunction-CbOSPlOM.js";import{n as ie}from"./imageProcessingDeclaration-CsQRWorP.js";import{t as ae}from"./lightUboDeclaration-D8UdzSbK.js";import{t as oe}from"./shadowsFragmentFunctions-RKgK8lzG.js";import{n as se}from"./imageProcessingFunctions-BUdP1mXG.js";import{t as ce}from"./lightFragment-BxaGn36w.js";import{t as le}from"./pbrUboDeclaration-DsBpKW0i.js";import{t as ue}from"./pbrBRDFFunctions--PgSGUtK.js";import{t as de}from"./harmonicsFunctions-Do4xQuBN.js";import{i as fe,n as pe,r as me,t as he}from"./oitFragment-BR0aUfGI.js";import{a as ge,c as _e,d as ve,f as ye,i as be,l as xe,n as Se,o as Ce,r as we,s as Te,t as Ee,u as De}from"./pbrDebug-Z2Jk9a9K.js";import{t as Oe}from"./samplerFragmentDeclaration-f0Wo7yG8.js";import{n as ke,t as Ae}from"./hdrFilteringFunctions-BX7YdAMA.js";import{n as je}from"./bumpFragmentMainFunctions-Rn9DQRoE.js";import{n as Me}from"./bumpFragmentFunctions-3FN7UNlG.js";import{n as Ne}from"./bumpFragment-BE0my69A.js";var c,l,Pe=e((()=>{t(),c=`samplerFragmentAlternateDeclaration`,l=`#ifdef _DEFINENAME_
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[c]||(n.IncludesShadersStoreWGSL[c]=l)})),u,d,Fe=e((()=>{t(),Oe(),Pe(),u=`pbrFragmentSamplersDeclaration`,d=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`,n.IncludesShadersStoreWGSL[u]||(n.IncludesShadersStoreWGSL[u]=d)})),f,p,m=e((()=>{t(),te(),f=`pbrBlockAlbedoOpacity`,p=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`,n.IncludesShadersStoreWGSL[f]||(n.IncludesShadersStoreWGSL[f]=p)})),h,g,_=e((()=>{t(),h=`pbrBlockReflectivity`,g=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`,n.IncludesShadersStoreWGSL[h]||(n.IncludesShadersStoreWGSL[h]=g)})),v,y,Ie=e((()=>{t(),v=`pbrBlockAmbientOcclusion`,y=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`,n.IncludesShadersStoreWGSL[v]||(n.IncludesShadersStoreWGSL[v]=y)})),b,x,S=e((()=>{t(),b=`pbrBlockAlphaFresnel`,x=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[b]||(n.IncludesShadersStoreWGSL[b]=x)})),C,w,Le=e((()=>{t(),C=`pbrBlockAnisotropic`,w=`#ifdef ANISOTROPIC
...
#endif
`,n.IncludesShadersStoreWGSL[C]||(n.IncludesShadersStoreWGSL[C]=w)})),T,E,Re=e((()=>{t(),T=`pbrBlockReflection`,E=`#ifdef REFLECTION
...
#endif
`,n.IncludesShadersStoreWGSL[T]||(n.IncludesShadersStoreWGSL[T]=E)})),D,O,ze=e((()=>{t(),D=`pbrBlockSheen`,O=`#ifdef SHEEN
...
#endif
`,n.IncludesShadersStoreWGSL[D]||(n.IncludesShadersStoreWGSL[D]=O)})),k,A,Be=e((()=>{t(),k=`pbrBlockClearcoat`,A=`struct clearcoatOutParams
...
return outParams;}
#endif
`,n.IncludesShadersStoreWGSL[k]||(n.IncludesShadersStoreWGSL[k]=A)})),j,M,Ve=e((()=>{t(),j=`pbrBlockIridescence`,M=`struct iridescenceOutParams
...
#endif
`,n.IncludesShadersStoreWGSL[j]||(n.IncludesShadersStoreWGSL[j]=M)})),N,P,He=e((()=>{t(),N=`pbrBlockSubSurface`,P=`struct subSurfaceOutParams
...
return outParams;}
#endif
`,n.IncludesShadersStoreWGSL[N]||(n.IncludesShadersStoreWGSL[N]=P)})),F,I,Ue=e((()=>{t(),F=`pbrBlockNormalFinal`,I=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[F]||(n.IncludesShadersStoreWGSL[F]=I)})),L,R,We=e((()=>{t(),L=`pbrBlockLightmapInit`,R=`#ifdef LIGHTMAP
...
#endif
`,n.IncludesShadersStoreWGSL[L]||(n.IncludesShadersStoreWGSL[L]=R)})),z,B,Ge=e((()=>{t(),z=`pbrBlockGeometryInfo`,B=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[z]||(n.IncludesShadersStoreWGSL[z]=B)})),V,H,Ke=e((()=>{t(),V=`pbrBlockReflectance`,H=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[V]||(n.IncludesShadersStoreWGSL[V]=H)})),U,W,qe=e((()=>{t(),U=`pbrBlockDirectLighting`,W=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`,n.IncludesShadersStoreWGSL[U]||(n.IncludesShadersStoreWGSL[U]=W)})),G,K,Je=e((()=>{t(),G=`pbrBlockFinalLitComponents`,K=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[G]||(n.IncludesShadersStoreWGSL[G]=K)})),q,J,Ye=e((()=>{t(),q=`pbrBlockFinalUnlitComponents`,J=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`,n.IncludesShadersStoreWGSL[q]||(n.IncludesShadersStoreWGSL[q]=J)})),Y,X,Xe=e((()=>{t(),Y=`pbrBlockFinalColorComposition`,X=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`,n.IncludesShadersStoreWGSL[Y]||(n.IncludesShadersStoreWGSL[Y]=X)})),Z,Q,$,Ze=e((()=>{t(),fe(),me(),le(),ye(),ae(),Fe(),ie(),ne(),re(),r(),ee(),ve(),ke(),De(),se(),oe(),de(),xe(),_e(),ue(),Ae(),Ce(),ge(),je(),Me(),s(),m(),_(),Ie(),S(),Le(),Re(),ze(),Be(),Ve(),He(),o(),be(),Ne(),Ue(),pe(),We(),Ge(),Te(),Ke(),qe(),ce(),Je(),Ye(),Xe(),i(),a(),we(),Se(),he(),Ee(),Z=`pbrPixelShader`,Q=`#define PBR_FRAGMENT_SHADER
...
`,n.ShadersStoreWGSL[Z]||(n.ShadersStoreWGSL[Z]=Q),$={name:Z,shader:Q}}));export{$ as n,Ze as t};
//# sourceMappingURL=pbr.fragment-B0BXXntM.js.map