...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`,n.IncludesShadersStore[r]||(n.IncludesShadersStore[r]=i)})),o,s,c=e((()=>{t(),o=`hdrFilteringFunctions`,s=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
//# sourceMappingURL=hdrFilteringFunctions-Bt0Z2iiv.js.map