import{t as e}from"./shaderStore-DV7KRD9j.js";import"./helperFunctions-eXLWT6od.js";import"./logDepthDeclaration-CZlXXL9z.js";import"./meshUboDeclaration-gAmrP9ue.js";import"./fogVertex-D6fmQM0i.js";import"./logDepthVertex-By-SnCas.js";const t=`gaussianSplattingVertexDeclaration`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=`attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;`);const n=`gaussianSplattingUboDeclaration`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=`#include<sceneUboDeclaration>
...
`);const r=`gaussianSplatting`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
vCenter 
+ ((meshPos.x*majorAxis
+ meshPos.y*minorAxis)*invViewport*scaleFactor)*scale,pos2d.zw);}`);const i=`gaussianSplattingVertexShader`,a=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=a);const o={name:i,shader:a};export{o as t};