import{n as e}from"./chunk-Dy9vhvp_.js";import{n as t,t as n}from"./shaderStore-CAkcDnHW.js";import{n as r}from"./helperFunctions-D8KlzsZp.js";import{t as i}from"./logDepthDeclaration-CBgNGOLC.js";import{t as a}from"./sceneUboDeclaration-gi2SMQ_g.js";import{t as o}from"./meshUboDeclaration-jmeVjD0-.js";import{n as s}from"./clipPlaneVertexDeclaration-CtNex3wB.js";import{t as c}from"./fogVertexDeclaration-BcuMI541.js";import{n as l}from"./clipPlaneVertex-BW-PqQBf.js";import{t as u}from"./fogVertex-D_kLEcDX.js";import{t as d}from"./logDepthVertex-B8gDFpaz.js";var f,p,m,h=e((()=>{t(),f=`gaussianSplattingVertexDeclaration`,p=`attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;`,n.IncludesShadersStore[f]||(n.IncludesShadersStore[f]=p),m={name:f,shader:p}})),g,_,v=e((()=>{t(),a(),o(),g=`gaussianSplattingUboDeclaration`,_=`#include<sceneUboDeclaration>
...
`,n.IncludesShadersStore[g]||(n.IncludesShadersStore[g]=_)})),y,b,x=e((()=>{t(),y=`gaussianSplatting`,b=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
vCenter 
+ ((meshPos.x*majorAxis
+ meshPos.y*minorAxis)*invViewport*scaleFactor)*scale,pos2d.zw);}`,n.IncludesShadersStore[y]||(n.IncludesShadersStore[y]=b)})),S,C,w,T=e((()=>{t(),h(),v(),s(),c(),i(),r(),x(),l(),u(),d(),S=`gaussianSplattingVertexShader`,C=`#include<__decl__gaussianSplattingVertex>
...
//# sourceMappingURL=gaussianSplatting.vertex-0_JO0TtU.js.map