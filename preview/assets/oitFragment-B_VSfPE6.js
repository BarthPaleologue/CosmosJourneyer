import{t as e}from"./shaderStore-DV7KRD9j.js";const t=`decalFragmentDeclaration`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`);const n=`prePassDeclaration`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=`#ifdef PREPASS
...
#endif
#endif
`);const r=`oitDeclaration`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`);const i=`lightFragmentDeclaration`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=`#ifdef LIGHT{X}
...
#endif
#endif
`);const a=`lightUboDeclaration`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`);const s=`clusteredLightingFunctions`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`);const c=`shadowsFragmentFunctions`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=`#ifdef SHADOWS
...
#endif
`);const u=`imageProcessingFunctions`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`);const d=`decalFragment`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`);const f=`depthPrePass`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`);const p=`lightFragment`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=`#ifdef LIGHT{X}
...
#endif
#endif
`);const m=`oitFragment`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
