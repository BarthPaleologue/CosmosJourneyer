...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`,n.IncludesShadersStoreWGSL[r]||(n.IncludesShadersStoreWGSL[r]=i)})),o,s,c=e((()=>{t(),o=`hdrFilteringFunctions`,s=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
//# sourceMappingURL=hdrFilteringFunctions-BX7YdAMA.js.map