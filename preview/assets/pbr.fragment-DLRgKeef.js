import{n as e}from"./chunk-Cyuzqnbw.js";import{n as t,t as n}from"./shaderStore-DR7YeKlK.js";import{n as ee}from"./helperFunctions-Dv88wD2h.js";import{n as te}from"./clipPlaneFragmentDeclaration-BjnOaHEy.js";import{t as ne}from"./logDepthDeclaration-CePzDkyG.js";import{n as re}from"./fogFragmentDeclaration-CUdxThAV.js";import{t as ie}from"./logDepthFragment-DrsGQlzY.js";import{t as ae}from"./fogFragment-DyC7Abjg.js";import{n as oe}from"./clipPlaneFragment-BDIjmn0N.js";import{t as se}from"./clusteredLightingFunctions-BikDqZPG.js";import{t as ce}from"./reflectionFunction-CX-6LeJj.js";import{n as le}from"./imageProcessingDeclaration-CLTJjnxq.js";import{t as ue}from"./lightFragmentDeclaration-aB72VJiS.js";import{t as de}from"./lightUboDeclaration-D0tQ2g08.js";import{t as r}from"./shadowsFragmentFunctions-DPKgBXmm.js";import{n as fe}from"./imageProcessingFunctions-C9H-h1Xs.js";import{t as pe}from"./lightFragment-Dkrm5v8_.js";import{t as me}from"./pbrUboDeclaration-R0atzInc.js";import{t as he}from"./pbrBRDFFunctions-VhVcK8yq.js";import{t as ge}from"./harmonicsFunctions-p_9_fmHa.js";import{a as _e,i as ve,n as ye,r as be,t as xe}from"./oitFragment-BsUYK0Rr.js";import{a as Se,c as Ce,d as we,i as Te,l as Ee,n as De,o as Oe,r as ke,s as Ae,t as je,u as Me}from"./pbrDebug-B_-IJO2L.js";import{t as Ne}from"./samplerFragmentDeclaration-vMxbLxgk.js";import{n as Pe,t as Fe}from"./hdrFilteringFunctions-Bt0Z2iiv.js";import{n as Ie}from"./bumpFragmentMainFunctions-DNMNqR10.js";import{n as Le}from"./bumpFragmentFunctions-DgvURtCD.js";import{t as Re}from"./decalFragment-DpoX_XUU.js";import{n as ze}from"./bumpFragment-0TCF9Xwh.js";var i,a,Be=e((()=>{t(),be(),i=`pbrFragmentDeclaration`,a=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`,n.IncludesShadersStore[i]||(n.IncludesShadersStore[i]=a)})),o,s,Ve=e((()=>{t(),o=`samplerFragmentAlternateDeclaration`,s=`#ifdef _DEFINENAME_
...
#endif
#endif
`,n.IncludesShadersStore[o]||(n.IncludesShadersStore[o]=s)})),c,l,He=e((()=>{t(),Ne(),Ve(),c=`pbrFragmentSamplersDeclaration`,l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`,n.IncludesShadersStore[c]||(n.IncludesShadersStore[c]=l)})),u,d,Ue=e((()=>{t(),Re(),u=`pbrBlockAlbedoOpacity`,d=`struct albedoOpacityOutParams
...
`,n.IncludesShadersStore[u]||(n.IncludesShadersStore[u]=d)})),f,p,We=e((()=>{t(),f=`pbrBlockReflectivity`,p=`struct reflectivityOutParams
...
`,n.IncludesShadersStore[f]||(n.IncludesShadersStore[f]=p)})),m,h,Ge=e((()=>{t(),m=`pbrBlockAmbientOcclusion`,h=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`,n.IncludesShadersStore[m]||(n.IncludesShadersStore[m]=h)})),g,_,Ke=e((()=>{t(),g=`pbrBlockAlphaFresnel`,_=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`,n.IncludesShadersStore[g]||(n.IncludesShadersStore[g]=_)})),v,y,qe=e((()=>{t(),v=`pbrBlockAnisotropic`,y=`#ifdef ANISOTROPIC
...
#endif
`,n.IncludesShadersStore[v]||(n.IncludesShadersStore[v]=y)})),b,x,Je=e((()=>{t(),b=`pbrBlockReflection`,x=`#ifdef REFLECTION
...
#endif
`,n.IncludesShadersStore[b]||(n.IncludesShadersStore[b]=x)})),S,C,Ye=e((()=>{t(),S=`pbrBlockSheen`,C=`#ifdef SHEEN
...
#endif
`,n.IncludesShadersStore[S]||(n.IncludesShadersStore[S]=C)})),w,T,Xe=e((()=>{t(),w=`pbrBlockClearcoat`,T=`struct clearcoatOutParams
...
return outParams;}
#endif
`,n.IncludesShadersStore[w]||(n.IncludesShadersStore[w]=T)})),E,D,Ze=e((()=>{t(),E=`pbrBlockIridescence`,D=`struct iridescenceOutParams
...
#endif
`,n.IncludesShadersStore[E]||(n.IncludesShadersStore[E]=D)})),O,k,Qe=e((()=>{t(),O=`pbrBlockSubSurface`,k=`struct subSurfaceOutParams
...
return outParams;}
#endif
`,n.IncludesShadersStore[O]||(n.IncludesShadersStore[O]=k)})),A,j,M=e((()=>{t(),A=`pbrBlockReflectance0`,j=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`,n.IncludesShadersStore[A]||(n.IncludesShadersStore[A]=j)})),N,P,$e=e((()=>{t(),se(),M(),N=`pbrClusteredLightingFunctions`,P=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`,n.IncludesShadersStore[N]||(n.IncludesShadersStore[N]=P)})),F,I,et=e((()=>{t(),F=`pbrBlockNormalFinal`,I=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`,n.IncludesShadersStore[F]||(n.IncludesShadersStore[F]=I)})),L,R,tt=e((()=>{t(),L=`pbrBlockLightmapInit`,R=`#ifdef LIGHTMAP
...
#endif
`,n.IncludesShadersStore[L]||(n.IncludesShadersStore[L]=R)})),z,B,nt=e((()=>{t(),z=`pbrBlockGeometryInfo`,B=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`,n.IncludesShadersStore[z]||(n.IncludesShadersStore[z]=B)})),V,H,rt=e((()=>{t(),V=`pbrBlockReflectance`,H=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`,n.IncludesShadersStore[V]||(n.IncludesShadersStore[V]=H)})),U,W,it=e((()=>{t(),U=`pbrBlockDirectLighting`,W=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`,n.IncludesShadersStore[U]||(n.IncludesShadersStore[U]=W)})),G,K,at=e((()=>{t(),G=`pbrBlockFinalLitComponents`,K=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`,n.IncludesShadersStore[G]||(n.IncludesShadersStore[G]=K)})),q,J,ot=e((()=>{t(),q=`pbrBlockFinalUnlitComponents`,J=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`,n.IncludesShadersStore[q]||(n.IncludesShadersStore[q]=J)})),Y,X,st=e((()=>{t(),Y=`pbrBlockFinalColorComposition`,X=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`,n.IncludesShadersStore[Y]||(n.IncludesShadersStore[Y]=X)})),Z,Q,$,ct=e((()=>{t(),_e(),ve(),Be(),me(),we(),ue(),de(),He(),le(),te(),ne(),re(),ee(),Me(),Pe(),Ee(),fe(),r(),ge(),Ce(),Ae(),he(),Fe(),Oe(),Se(),Ie(),Le(),ce(),Ue(),We(),Ge(),Ke(),qe(),Je(),Ye(),Xe(),Ze(),Qe(),$e(),oe(),Te(),ze(),et(),ye(),tt(),nt(),M(),rt(),it(),pe(),at(),ot(),st(),ie(),ae(),ke(),De(),xe(),je(),Z=`pbrPixelShader`,Q=`#define PBR_FRAGMENT_SHADER
...
//# sourceMappingURL=pbr.fragment-DLRgKeef.js.map