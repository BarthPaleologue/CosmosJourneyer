import{n as e}from"./chunk-Cyuzqnbw.js";import{n as t,t as n}from"./shaderStore-DR7YeKlK.js";import{n as ee}from"./helperFunctions-DxRVZtIm.js";import{n as te}from"./clipPlaneFragmentDeclaration-Das-drhD.js";import{t as ne}from"./logDepthDeclaration-C-yUb1nt.js";import{n as re}from"./fogFragmentDeclaration-CTXnVo1a.js";import{t as ie}from"./logDepthFragment-DpQZNVQF.js";import{t as r}from"./fogFragment-B8UcrDCQ.js";import{n as i}from"./clipPlaneFragment-BRFbw7xV.js";import{t as ae}from"./reflectionFunction-CbOSPlOM.js";import{n as oe}from"./imageProcessingDeclaration-CsQRWorP.js";import{t as se}from"./lightUboDeclaration-D8UdzSbK.js";import{t as ce}from"./shadowsFragmentFunctions-RKgK8lzG.js";import{n as a}from"./imageProcessingFunctions-BUdP1mXG.js";import{t as le}from"./pbrBRDFFunctions--PgSGUtK.js";import{t as ue}from"./harmonicsFunctions-Do4xQuBN.js";import{i as de,n as fe,r as pe,t as me}from"./oitFragment-BR0aUfGI.js";import{a as he,c as ge,d as _e,f as ve,i as ye,l as be,n as xe,o as Se,r as Ce,t as we,u as Te}from"./pbrDebug-Z2Jk9a9K.js";import{t as o}from"./samplerFragmentDeclaration-f0Wo7yG8.js";import{n as s,t as c}from"./hdrFilteringFunctions-BX7YdAMA.js";import{t as Ee}from"./openpbrUboDeclaration-r0XQZoQ5.js";var l,u,De=e((()=>{t(),o(),l=`openpbrFragmentSamplersDeclaration`,u=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`,n.IncludesShadersStoreWGSL[l]||(n.IncludesShadersStoreWGSL[l]=u)})),d,f,Oe=e((()=>{t(),d=`openpbrNormalMapFragmentMainFunctions`,f=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`,n.IncludesShadersStoreWGSL[d]||(n.IncludesShadersStoreWGSL[d]=f)})),p,m,ke=e((()=>{t(),o(),p=`openpbrNormalMapFragmentFunctions`,m=`#if defined(GEOMETRY_NORMAL)
...
#endif
`,n.IncludesShadersStoreWGSL[p]||(n.IncludesShadersStoreWGSL[p]=m)})),h,g,Ae=e((()=>{t(),h=`openpbrDielectricReflectance`,g=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`,n.IncludesShadersStoreWGSL[h]||(n.IncludesShadersStoreWGSL[h]=g)})),_,v,y=e((()=>{t(),_=`openpbrConductorReflectance`,v=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`,n.IncludesShadersStoreWGSL[_]||(n.IncludesShadersStoreWGSL[_]=v)})),b,x,S=e((()=>{t(),b=`openpbrAmbientOcclusionFunctions`,x=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`,n.IncludesShadersStoreWGSL[b]||(n.IncludesShadersStoreWGSL[b]=x)})),C,w,je=e((()=>{t(),C=`openpbrGeometryInfo`,w=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`,n.IncludesShadersStoreWGSL[C]||(n.IncludesShadersStoreWGSL[C]=w)})),T,E,Me=e((()=>{t(),T=`openpbrIblFunctions`,E=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`,n.IncludesShadersStoreWGSL[T]||(n.IncludesShadersStoreWGSL[T]=E)})),D,O,Ne=e((()=>{t(),D=`openpbrNormalMapFragment`,O=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`,n.IncludesShadersStoreWGSL[D]||(n.IncludesShadersStoreWGSL[D]=O)})),k,A,Pe=e((()=>{t(),k=`openpbrBlockNormalFinal`,A=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[k]||(n.IncludesShadersStoreWGSL[k]=A)})),j,M,Fe=e((()=>{t(),j=`openpbrBaseLayerData`,M=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`,n.IncludesShadersStoreWGSL[N]||(n.IncludesShadersStoreWGSL[N]=P)})),F,I,Le=e((()=>{t(),F=`openpbrCoatLayerData`,I=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`,n.IncludesShadersStoreWGSL[F]||(n.IncludesShadersStoreWGSL[F]=I)})),L,R,Re=e((()=>{t(),L=`openpbrThinFilmLayerData`,R=`#ifdef THIN_FILM
...
#endif
`,n.IncludesShadersStoreWGSL[L]||(n.IncludesShadersStoreWGSL[L]=R)})),z,B,ze=e((()=>{t(),z=`openpbrFuzzLayerData`,B=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[z]||(n.IncludesShadersStoreWGSL[z]=B)})),V,H,Be=e((()=>{t(),V=`openpbrAmbientOcclusionData`,H=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`,n.IncludesShadersStoreWGSL[V]||(n.IncludesShadersStoreWGSL[V]=H)})),U,W,Ve=e((()=>{t(),U=`openpbrBackgroundTransmission`,W=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`,n.IncludesShadersStoreWGSL[U]||(n.IncludesShadersStoreWGSL[U]=W)})),G,K,He=e((()=>{t(),G=`openpbrEnvironmentLighting`,K=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[G]||(n.IncludesShadersStoreWGSL[G]=K)})),q,J,Ue=e((()=>{t(),q=`openpbrDirectLightingInit`,J=`#ifdef LIGHT{X}
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[q]||(n.IncludesShadersStoreWGSL[q]=J)})),Y,X,We=e((()=>{t(),Y=`openpbrDirectLighting`,X=`#ifdef LIGHT{X}
...
#endif
`,n.IncludesShadersStoreWGSL[Y]||(n.IncludesShadersStoreWGSL[Y]=X)})),Z,Q,$,Ge=e((()=>{t(),de(),pe(),Ee(),ve(),se(),De(),oe(),te(),ne(),re(),ee(),_e(),s(),Te(),a(),ce(),ue(),be(),ge(),le(),c(),Se(),he(),Oe(),ke(),ae(),Ae(),y(),S(),je(),Me(),i(),ye(),Ne(),Pe(),Fe(),Ie(),Le(),Re(),ze(),Be(),fe(),Ve(),He(),Ue(),We(),ie(),r(),Ce(),xe(),me(),we(),Z=`openpbrPixelShader`,Q=`#define OPENPBR_FRAGMENT_SHADER
...
//# sourceMappingURL=openpbr.fragment-BjmmZfxK.js.map