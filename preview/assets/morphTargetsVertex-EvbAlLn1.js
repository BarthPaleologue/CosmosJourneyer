import{t as e}from"./shaderStore-DV7KRD9j.js";const t=`morphTargetsVertexGlobalDeclaration`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=`#ifdef MORPHTARGETS
...
#endif
#endif
`);const n=`morphTargetsVertexDeclaration`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=`#ifdef MORPHTARGETS
...
#endif
#endif
`);const i=`morphTargetsVertex`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
