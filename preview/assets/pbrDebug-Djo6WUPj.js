import{n as e}from"./rolldown-runtime-CNC7AqOf.js";import{n as t,t as n}from"./shaderStore-C5hmi3ce.js";import{t as r}from"./ltcHelperFunctions-BnZfyhvZ.js";import{t as i}from"./mainUVVaryingDeclaration-SpKsMnn7.js";var a,o,s=e((()=>{t(),i(),a=`pbrFragmentExtraDeclaration`,o=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`,n.IncludesShadersStore[a]||(n.IncludesShadersStore[a]=o)})),c,l,u=e((()=>{t(),c=`subSurfaceScatteringFunctions`,l=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`,n.IncludesShadersStore[c]||(n.IncludesShadersStore[c]=l)})),d,f,p=e((()=>{t(),d=`pbrHelperFunctions`,f=`#define MINIMUMVARIANCE 0.0005
...
#endif
`,n.IncludesShadersStore[d]||(n.IncludesShadersStore[d]=f)})),m,h,g=e((()=>{t(),r(),m=`pbrDirectLightingSetupFunctions`,h=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`,n.IncludesShadersStore[m]||(n.IncludesShadersStore[m]=h)})),_,v,y=e((()=>{t(),_=`pbrDirectLightingFalloffFunctions`,v=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`,n.IncludesShadersStore[_]||(n.IncludesShadersStore[_]=v)})),b,x,S=e((()=>{t(),b=`pbrDirectLightingFunctions`,x=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`,n.IncludesShadersStore[b]||(n.IncludesShadersStore[b]=x)})),C,w,T=e((()=>{t(),C=`pbrIBLFunctions`,w=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`,n.IncludesShadersStore[C]||(n.IncludesShadersStore[C]=w)})),E,D,O=e((()=>{t(),E=`pbrBlockNormalGeometric`,D=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`,n.IncludesShadersStore[E]||(n.IncludesShadersStore[E]=D)})),k,A,j=e((()=>{t(),k=`pbrBlockImageProcessing`,A=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`,n.IncludesShadersStore[k]||(n.IncludesShadersStore[k]=A)})),M,N,P=e((()=>{t(),M=`pbrBlockPrePass`,N=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`,n.IncludesShadersStore[M]||(n.IncludesShadersStore[M]=N)})),F,I,L=e((()=>{t(),F=`pbrDebug`,I=`#if DEBUGMODE>0
...
//# sourceMappingURL=pbrDebug-Djo6WUPj.js.map