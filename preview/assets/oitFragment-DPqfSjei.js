import{t as e}from"./shaderStore-DV7KRD9j.js";const t=`prePassDeclaration`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=`#ifdef PREPASS
...
#endif
`);const r=`lightUboDeclaration`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`);const i=`ltcHelperFunctions`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`);const a=`clusteredLightingFunctions`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`);const o=`shadowsFragmentFunctions`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`);const c=`imageProcessingFunctions`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`);const l=`decalFragment`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=`#ifdef DECAL
...
#endif
`);const u=`depthPrePass`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`);const d=`lightFragment`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=`#ifdef LIGHT{X}
