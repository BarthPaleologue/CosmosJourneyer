import{t as e}from"./shaderStore-DV7KRD9j.js";import"./logDepthDeclaration-U055czMZ.js";import"./meshUboDeclaration-CQ1l-BFL.js";import"./helperFunctions-DLE-DtJi.js";import"./fogVertex-7ZhSSvTZ.js";import"./logDepthVertex-CLdLSAu5.js";const t=`gaussianSplatting`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=`fn getDataUV(index: f32,dataTextureSize: vec2f)->vec2<f32> {let y: f32=floor(index/dataTextureSize.x);let x: f32=index-y*dataTextureSize.x;return vec2f((x+0.5),(y+0.5));}
...
pos2d.z,
pos2d.w
);}`);const n=`gaussianSplattingVertexShader`,r=`#include<sceneUboDeclaration>
