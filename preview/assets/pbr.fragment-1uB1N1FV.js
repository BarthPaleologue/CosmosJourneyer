import{t as e}from"./shaderStore-DV7KRD9j.js";import"./helperFunctions-eXLWT6od.js";import"./clipPlaneFragment-HdEqjLhi.js";import"./logDepthDeclaration-CZlXXL9z.js";import"./logDepthFragment-Bbfn4dc_.js";import"./bumpFragment-C15g1Rf5.js";import"./bumpFragmentFunctions-D4cNEG9H.js";import"./bumpFragmentMainFunctions-C3zq12uc.js";import"./reflectionFunction-RosBO-An.js";import"./oitFragment-B_VSfPE6.js";import"./mainUVVaryingDeclaration-MRyxeShM.js";import"./pbrBRDFFunctions-DLc5D6tJ.js";const t=`pbrFragmentDeclaration`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`);const n=`pbrFragmentExtraDeclaration`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`);const r=`samplerFragmentAlternateDeclaration`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=`#ifdef _DEFINENAME_
...
#endif
#endif
`);const i=`pbrFragmentSamplersDeclaration`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`);const a=`subSurfaceScatteringFunctions`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`);const o=`importanceSampling`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`);const s=`pbrHelperFunctions`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=`#define MINIMUMVARIANCE 0.0005
...
#endif
`);const c=`pbrDirectLightingSetupFunctions`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`);const l=`pbrDirectLightingFalloffFunctions`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`);const u=`hdrFilteringFunctions`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`);const d=`pbrDirectLightingFunctions`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`);const f=`pbrIBLFunctions`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`);const p=`pbrBlockAlbedoOpacity`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=`struct albedoOpacityOutParams
...
`);const m=`pbrBlockReflectivity`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=`struct reflectivityOutParams
...
`);const h=`pbrBlockAmbientOcclusion`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`);const g=`pbrBlockAlphaFresnel`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`);const _=`pbrBlockAnisotropic`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=`#ifdef ANISOTROPIC
...
#endif
`);const v=`pbrBlockReflection`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=`#ifdef REFLECTION
...
#endif
`);const y=`pbrBlockSheen`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=`#ifdef SHEEN
...
#endif
`);const b=`pbrBlockClearcoat`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=`struct clearcoatOutParams
...
return outParams;}
#endif
`);const x=`pbrBlockIridescence`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=`struct iridescenceOutParams
...
#endif
`);const S=`pbrBlockSubSurface`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=`struct subSurfaceOutParams
...
#endif
`);const w=`pbrClusteredLightingFunctions`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
#endif
`);const E=`pbrBlockNormalFinal`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`);const D=`pbrBlockLightmapInit`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=`#ifdef LIGHTMAP
...
#endif
`);const O=`pbrBlockGeometryInfo`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`);const k=`pbrBlockReflectance`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`);const A=`pbrBlockDirectLighting`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`);const j=`pbrBlockFinalLitComponents`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`);const M=`pbrBlockFinalUnlitComponents`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`);const N=`pbrBlockFinalColorComposition`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
#endif
`);const F=`pbrBlockPrePass`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`);const I=`pbrDebug`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=`#if DEBUGMODE>0
...
#endif
`);const L=`pbrPixelShader`,R=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[L]||(e.ShadersStore[L]=R);const z={name:L,shader:R};export{z as pbrPixelShader};