...
`;n.l.IncludesShadersStore[a]||(n.l.IncludesShadersStore[a]=t),i(37317),i(74775),i(18189),i(71681),i(89381);let r="openpbrFragmentSamplersDeclaration",l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;n.l.IncludesShadersStore[r]||(n.l.IncludesShadersStore[r]=l),i(96563),i(30557),i(36036),i(30337),i(17796),i(63521),i(87522),i(25132),i(5762),i(48027),i(50908),i(97242),i(69871),i(81574),i(29416),i(66987),i(37639);let f="openpbrNormalMapFragmentMainFunctions",c=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;n.l.IncludesShadersStore[s]||(n.l.IncludesShadersStore[s]=d),i(98252);let m="openpbrDielectricReflectance",u=`struct ReflectanceParams
...
#endif
`;n.l.IncludesShadersStore[R]||(n.l.IncludesShadersStore[R]=h),i(46741),i(95230);let N="openpbrNormalMapFragment",A=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;n.l.IncludesShadersStore[N]||(n.l.IncludesShadersStore[N]=A);let S="openpbrBlockNormalFinal",T=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;n.l.IncludesShadersStore[S]||(n.l.IncludesShadersStore[S]=T);let L="openpbrBaseLayerData",F=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;n.l.IncludesShadersStore[L]||(n.l.IncludesShadersStore[L]=F);let O="openpbrCoatLayerData",C=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
#endif
`;n.l.IncludesShadersStore[M]||(n.l.IncludesShadersStore[M]=P),i(1378);let G="openpbrEnvironmentLighting",z=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
`;n.l.IncludesShadersStore[W]||(n.l.IncludesShadersStore[W]=U),i(18170),i(45857),i(57288),i(68750),i(20705),i(33730);let X="openpbrPixelShader",B=`#define OPENPBR_FRAGMENT_SHADER
