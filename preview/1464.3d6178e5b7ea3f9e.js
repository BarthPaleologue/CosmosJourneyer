...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["1464"],{18591:function(e,f,a){var t=a(28345);let r="hdrFilteringFunctions",n=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;t.l.IncludesShadersStoreWGSL[r]||(t.l.IncludesShadersStoreWGSL[r]=n)},25651:function(e,f,a){var t=a(28345);let r="pbrBRDFFunctions",n=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;t.l.IncludesShadersStoreWGSL[r]||(t.l.IncludesShadersStoreWGSL[r]=n)}}]);