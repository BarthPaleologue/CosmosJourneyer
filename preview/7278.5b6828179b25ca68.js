...
return result;}
#endif
`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f);let n={name:t,shader:f}},10877:function(e,r,i){i.r(r),i.d(r,{backgroundPixelShaderWGSL:()=>a});var o=i(34981);i(26516),i(52619),i(97789),i(97950),i(97534),i(29612),i(83290),i(5991),i(19239),i(22168),i(98912);let t="intersectionFunctions",f=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f),i(2430),i(81134),i(19355),i(64598);let n="backgroundPixelShader",l=`#include<backgroundUboDeclaration>
