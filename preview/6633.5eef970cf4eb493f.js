"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["6633"],{32991(e,i,t){var o=t(56863);let s="clusteredLightingFunctions",n=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;o.l.IncludesShadersStore[s]||(o.l.IncludesShadersStore[s]=n)},25449(e,i,t){var o=t(56863);let s="sceneVertexDeclaration",n=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
uniform mat4 viewProjectionR;
#endif
uniform mat4 view;uniform mat4 projection;uniform vec4 vEyePosition;
`;o.l.IncludesShadersStore[s]||(o.l.IncludesShadersStore[s]=n)},39008(e,i,t){t.r(i),t.d(i,{lightProxyVertexShader:()=>a});var o=t(56863);t(25449),t(26963),t(32991);let s="lightProxyVertexShader",n=`attribute vec3 position;flat varying vec2 vLimits;flat varying highp uint vMask;
