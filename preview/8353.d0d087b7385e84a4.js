...
#endif
`;o.l.IncludesShadersStoreWGSL[n]||(o.l.IncludesShadersStoreWGSL[n]=i),a(36650),a(51644),a(67827),a(39580),a(41647),a(1502),a(7779),a(86713),a(94323),a(66998),a(23365),a(95193),a(74632),a(13435),a(62919),a(642),a(49460);let t="openpbrNormalMapFragmentMainFunctions",f=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f);let l="openpbrNormalMapFragmentFunctions",c=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;o.l.IncludesShadersStoreWGSL[l]||(o.l.IncludesShadersStoreWGSL[l]=c),a(65033);let s="openpbrDielectricReflectance",m=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;o.l.IncludesShadersStoreWGSL[s]||(o.l.IncludesShadersStoreWGSL[s]=m);let u="openpbrConductorReflectance",d=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;o.l.IncludesShadersStoreWGSL[u]||(o.l.IncludesShadersStoreWGSL[u]=d);let p="openpbrBlockAmbientOcclusion",g=`struct ambientOcclusionOutParams
...
`;o.l.IncludesShadersStoreWGSL[p]||(o.l.IncludesShadersStoreWGSL[p]=g);let v="openpbrGeometryInfo",_=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;o.l.IncludesShadersStoreWGSL[v]||(o.l.IncludesShadersStoreWGSL[v]=_);let I="openpbrIblFunctions",S=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;o.l.IncludesShadersStoreWGSL[I]||(o.l.IncludesShadersStoreWGSL[I]=S),a(69226),a(10917);let E="openpbrNormalMapFragment",h=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;o.l.IncludesShadersStoreWGSL[E]||(o.l.IncludesShadersStoreWGSL[E]=h);let R="openpbrBlockNormalFinal",N=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;o.l.IncludesShadersStoreWGSL[R]||(o.l.IncludesShadersStoreWGSL[R]=N);let L="openpbrBaseLayerData",A=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;o.l.IncludesShadersStoreWGSL[L]||(o.l.IncludesShadersStoreWGSL[L]=A);let T="openpbrCoatLayerData",F=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;o.l.IncludesShadersStoreWGSL[T]||(o.l.IncludesShadersStoreWGSL[T]=F);let O="openpbrThinFilmLayerData",b=`#ifdef THIN_FILM
...
#endif
#endif
`;o.l.IncludesShadersStoreWGSL[O]||(o.l.IncludesShadersStoreWGSL[O]=b);let C="openpbrFuzzLayerData",M=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;o.l.IncludesShadersStoreWGSL[C]||(o.l.IncludesShadersStoreWGSL[C]=M),a(95987);let D="openpbrEnvironmentLighting",x=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;o.l.IncludesShadersStoreWGSL[D]||(o.l.IncludesShadersStoreWGSL[D]=x);let G="openpbrDirectLightingInit",z=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.l.IncludesShadersStoreWGSL[G]||(o.l.IncludesShadersStoreWGSL[G]=z);let P="openpbrDirectLighting",y=`#ifdef LIGHT{X}
...
#endif
`;o.l.IncludesShadersStoreWGSL[P]||(o.l.IncludesShadersStoreWGSL[P]=y),a(23199),a(36362),a(69691),a(27209),a(51414),a(16599);let W="openpbrPixelShader",U=`#define OPENPBR_FRAGMENT_SHADER
...
`;o.l.ShadersStoreWGSL[W]||(o.l.ShadersStoreWGSL[W]=U);let X={name:W,shader:U}}}]);