...
return result;}
#endif
`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f);let n={name:t,shader:f}},73473(e,r,i){i.r(r),i.d(r,{backgroundPixelShaderWGSL:()=>a});var o=i(20854);i(13111),i(46282),i(66226),i(97001),i(82047),i(30017),i(14905),i(58240),i(97942),i(41267),i(69283);let t="intersectionFunctions",f=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f),i(92047),i(41467),i(67072),i(22847);let n="backgroundPixelShader",l=`#include<backgroundUboDeclaration>
