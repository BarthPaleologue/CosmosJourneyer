...
`;n.l.IncludesShadersStore[a]||(n.l.IncludesShadersStore[a]=t),i(93431),i(61133),i(91055),i(35239),i(23355);let r="openpbrFragmentSamplersDeclaration",l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;n.l.IncludesShadersStore[r]||(n.l.IncludesShadersStore[r]=l),i(62097),i(71531),i(20142),i(27115),i(34450),i(10119),i(7620),i(61198),i(9704),i(39505),i(32270),i(39564),i(52437),i(31896),i(69342),i(3106),i(23821);let f="openpbrNormalMapFragmentMainFunctions",c=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;n.l.IncludesShadersStore[s]||(n.l.IncludesShadersStore[s]=d),i(94538);let m="openpbrDielectricReflectance",u=`struct ReflectanceParams
...
#endif
`;n.l.IncludesShadersStore[h]||(n.l.IncludesShadersStore[h]=R),i(32887),i(17404);let N="openpbrNormalMapFragment",A=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
#endif
`;n.l.IncludesShadersStore[M]||(n.l.IncludesShadersStore[M]=P),i(84380);let G="openpbrEnvironmentLighting",z=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
`;n.l.IncludesShadersStore[W]||(n.l.IncludesShadersStore[W]=U),i(88040),i(93911),i(63346),i(27724),i(72711),i(14152);let X="openpbrPixelShader",B=`#define OPENPBR_FRAGMENT_SHADER
