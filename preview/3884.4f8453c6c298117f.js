...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["3884"],{94011(e,t,a){var o=a(17984);let n="hdrFilteringFunctions",i=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=i)},39743(e,t,a){var o=a(17984);let n="importanceSampling",i=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=i)},43119(e,t,a){var o=a(17984);let n="pbrBRDFFunctions",i=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=i)}}]);