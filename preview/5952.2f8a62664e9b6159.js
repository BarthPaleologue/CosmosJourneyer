...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["5952"],{44025:function(e,i,t){t.r(i),t.d(i,{bumpFragment:()=>f});var o=t(22081);let a="bumpFragment",n=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;o.l.IncludesShadersStore[a]||(o.l.IncludesShadersStore[a]=n);let f={name:a,shader:n}},7104:function(e,i,t){t.r(i),t.d(i,{bumpFragmentFunctions:()=>f});var o=t(22081);t(89381);let a="bumpFragmentFunctions",n=`#if defined(BUMP)
...
#endif
`;o.l.IncludesShadersStore[a]||(o.l.IncludesShadersStore[a]=n);let f={name:a,shader:n}},84011:function(e,i,t){t.r(i),t.d(i,{bumpFragmentMainFunctions:()=>f});var o=t(22081);let a="bumpFragmentMainFunctions",n=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#ifdef OBJECTSPACE_NORMALMAP
...
#endif
`;o.l.IncludesShadersStore[a]||(o.l.IncludesShadersStore[a]=n);let f={name:a,shader:n}},27377:function(e,i,t){var o=t(22081);let a="clusteredLightingFunctions",n=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;o.l.IncludesShadersStore[a]||(o.l.IncludesShadersStore[a]=n)},76048:function(e,i,t){var o=t(22081);let a="decalFragment",n=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;o.l.IncludesShadersStore[a]||(o.l.IncludesShadersStore[a]=n)},28901:function(e,i,t){t.r(i),t.d(i,{lightFragment:()=>f});var o=t(22081);let a="lightFragment",n=`#ifdef LIGHT{X}
