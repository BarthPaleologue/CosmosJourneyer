"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["9639"],{39524:function(e,i,t){var o=t(29416);t(43002);let n="backgroundUboDeclaration",f=`layout(std140,column_major) uniform;uniform Material
...
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f)},70716:function(e,i,t){var o=t(29416);let n="clusteredLightingFunctions",f=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f)},28222:function(e,i,t){t.r(i),t.d(i,{lightFragment:()=>l});var o=t(29416);let n="lightFragment",f=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f);let l={name:n,shader:f}},47260:function(e,i,t){t.r(i),t.d(i,{lightsFragmentFunctions:()=>l});var o=t(29416);t(42050),t(70716);let n="lightsFragmentFunctions",f=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f);let l={name:n,shader:f}},7386:function(e,i,t){t.r(i),t.d(i,{backgroundPixelShader:()=>d});var o=t(29416);let n="backgroundFragmentDeclaration",f=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
uniform vec2 projectedGroundInfos;
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f),t(39524),t(47291),t(44333),t(69614),t(27896),t(89294),t(47260),t(17642),t(96631),t(94903),t(74024),t(46992);let l="intersectionFunctions",r=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;o.l.IncludesShadersStore[l]||(o.l.IncludesShadersStore[l]=r),t(21358),t(28222),t(60971),t(40998);let a="backgroundPixelShader",s=`#ifdef TEXTURELODSUPPORT
...
`;o.l.ShadersStore[a]||(o.l.ShadersStore[a]=s);let d={name:a,shader:s}}}]);