...
return result;}
#endif
`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f);let l={name:t,shader:f}},91485(e,r,i){i.r(r),i.d(r,{backgroundPixelShaderWGSL:()=>a});var o=i(77948);i(8589),i(22636),i(70884),i(76251),i(5961),i(69975),i(45747),i(98186),i(84444),i(98997),i(21161);let t="intersectionFunctions",f=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f),i(82589),i(39133),i(12194),i(87641);let l="backgroundPixelShader",n=`#include<backgroundUboDeclaration>
