"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["178"],{13533:function(e,i,t){var o=t(28345);t(24509);let n="backgroundUboDeclaration",f=`layout(std140,column_major) uniform;uniform Material
...
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f)},11801:function(e,i,t){var o=t(28345);let n="clusteredLightingFunctions",f=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f)},95917:function(e,i,t){t.r(i),t.d(i,{lightFragment:()=>l});var o=t(28345);let n="lightFragment",f=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f);let l={name:n,shader:f}},70919:function(e,i,t){t.r(i),t.d(i,{lightsFragmentFunctions:()=>l});var o=t(28345);t(30055),t(11801);let n="lightsFragmentFunctions",f=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f);let l={name:n,shader:f}},98761:function(e,i,t){t.r(i),t.d(i,{backgroundPixelShader:()=>d});var o=t(28345);let n="backgroundFragmentDeclaration",f=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
uniform vec2 projectedGroundInfos;
#endif
`;o.l.IncludesShadersStore[n]||(o.l.IncludesShadersStore[n]=f),t(13533),t(61244),t(42388),t(28363),t(4741),t(59513),t(70919),t(84003),t(92730),t(68908),t(41669),t(85081);let l="intersectionFunctions",r=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;o.l.IncludesShadersStore[l]||(o.l.IncludesShadersStore[l]=r),t(15149),t(95917),t(34898),t(67337);let a="backgroundPixelShader",s=`#ifdef TEXTURELODSUPPORT
