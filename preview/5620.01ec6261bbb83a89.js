...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["5620"],{40711(e,r,t){var a=t(20854);let o="clusteredLightingFunctions",i=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
...
`;a.l.IncludesShadersStoreWGSL[o]||(a.l.IncludesShadersStoreWGSL[o]=i)},97001(e,r,t){t.r(r),t.d(r,{imageProcessingDeclarationWGSL:()=>f});var a=t(20854);let o="imageProcessingDeclaration",i=`#ifdef EXPOSURE
...
#endif
`;a.l.IncludesShadersStoreWGSL[o]||(a.l.IncludesShadersStoreWGSL[o]=i);let f={name:o,shader:i}},58240(e,r,t){t.r(r),t.d(r,{imageProcessingFunctionsWGSL:()=>f});var a=t(20854);let o="imageProcessingFunctions",i=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;a.l.IncludesShadersStoreWGSL[o]||(a.l.IncludesShadersStoreWGSL[o]=i);let f={name:o,shader:i}},82047(e,r,t){t.r(r),t.d(r,{lightUboDeclarationWGSL:()=>f});var a=t(20854);let o="lightUboDeclaration",i=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
...
#endif
#endif
`;a.l.IncludesShadersStoreWGSL[o]||(a.l.IncludesShadersStoreWGSL[o]=i);let f={name:o,shader:i}},67493(e,r,t){var a=t(20854);let o="ltcHelperFunctions",i=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
vec3f( 0,1,0 ),
vec3f( 0,0,1 )
);result.Diffuse+=LTCEvaluate( normal,viewDir,position,mInvEmpty,rectCoords0,rectCoords1,rectCoords2,rectCoords3 );return result;}`;a.l.IncludesShadersStoreWGSL[o]||(a.l.IncludesShadersStoreWGSL[o]=i)},66226(e,r,t){t.r(r),t.d(r,{reflectionFunctionWGSL:()=>f});var a=t(20854);let o="reflectionFunction",i=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;a.l.IncludesShadersStoreWGSL[o]||(a.l.IncludesShadersStoreWGSL[o]=i);let f={name:o,shader:i}},14905(e,r,t){t.r(r),t.d(r,{shadowsFragmentFunctionsWGSL:()=>f});var a=t(20854);let o="shadowsFragmentFunctions",i=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
