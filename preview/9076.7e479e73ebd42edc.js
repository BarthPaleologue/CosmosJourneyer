...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["9076"],{52224(e,i,n){n.r(i),n.d(i,{bumpFragment:()=>o});var a=n(77948);let r="bumpFragment",f=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;a.l.IncludesShadersStore[r]||(a.l.IncludesShadersStore[r]=f);let o={name:r,shader:f}},67775(e,i,n){n.r(i),n.d(i,{bumpFragmentFunctions:()=>o});var a=n(77948);n(60059);let r="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;a.l.IncludesShadersStore[r]||(a.l.IncludesShadersStore[r]=f);let o={name:r,shader:f}},10140(e,i,n){n.r(i),n.d(i,{bumpFragmentMainFunctions:()=>o});var a=n(77948);let r="bumpFragmentMainFunctions",f=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#ifdef OBJECTSPACE_NORMALMAP
...
#endif
`;a.l.IncludesShadersStore[r]||(a.l.IncludesShadersStore[r]=f);let o={name:r,shader:f}},4799(e,i,n){var a=n(77948);let r="decalFragment",f=`#ifdef DECAL
#ifdef GAMMADECAL
...
`;a.l.IncludesShadersStore[r]||(a.l.IncludesShadersStore[r]=f),n(32598),n(10012),n(40164),n(83858),n(60059);let o="samplerFragmentAlternateDeclaration",t=`#ifdef _DEFINENAME_
...
#endif
#endif
`;a.l.IncludesShadersStore[o]||(a.l.IncludesShadersStore[o]=t);let c="pbrFragmentSamplersDeclaration",l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;a.l.IncludesShadersStore[c]||(a.l.IncludesShadersStore[c]=l),n(62762),n(18300),n(60243),n(97340),n(41007),n(79646),n(19075),n(57497),n(90131),n(39094),n(94917),n(70745),n(67080),n(4219),n(64967),n(226),n(42932),n(10140),n(67775),n(70121),n(4799);let d="pbrBlockAlbedoOpacity",s=`struct albedoOpacityOutParams
...
`;a.l.IncludesShadersStore[d]||(a.l.IncludesShadersStore[d]=s);let E="pbrBlockReflectivity",R=`struct reflectivityOutParams
...
`;a.l.IncludesShadersStore[E]||(a.l.IncludesShadersStore[E]=R);let C="pbrBlockAmbientOcclusion",m=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;a.l.IncludesShadersStore[C]||(a.l.IncludesShadersStore[C]=m);let u="pbrBlockAlphaFresnel",S=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;a.l.IncludesShadersStore[u]||(a.l.IncludesShadersStore[u]=S);let v="pbrBlockAnisotropic",A=`#ifdef ANISOTROPIC
...
#endif
`;a.l.IncludesShadersStore[v]||(a.l.IncludesShadersStore[v]=A);let I="pbrBlockReflection",N=`#ifdef REFLECTION
...
#endif
`;a.l.IncludesShadersStore[I]||(a.l.IncludesShadersStore[I]=N);let T="pbrBlockSheen",O=`#ifdef SHEEN
...
#endif
`;a.l.IncludesShadersStore[T]||(a.l.IncludesShadersStore[T]=O);let p="pbrBlockClearcoat",L=`struct clearcoatOutParams
...
return outParams;}
#endif
`;a.l.IncludesShadersStore[p]||(a.l.IncludesShadersStore[p]=L);let _="pbrBlockIridescence",M=`struct iridescenceOutParams
...
#endif
`;a.l.IncludesShadersStore[_]||(a.l.IncludesShadersStore[_]=M);let D="pbrBlockSubSurface",h=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;a.l.IncludesShadersStore[D]||(a.l.IncludesShadersStore[D]=h),n(92667);let F="pbrBlockReflectance0",g=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;a.l.IncludesShadersStore[F]||(a.l.IncludesShadersStore[F]=g);let P="pbrClusteredLightingFunctions",b=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;a.l.IncludesShadersStore[P]||(a.l.IncludesShadersStore[P]=b),n(42794),n(95365),n(52224);let U="pbrBlockNormalFinal",B=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;a.l.IncludesShadersStore[U]||(a.l.IncludesShadersStore[U]=B),n(86259);let y="pbrBlockLightmapInit",G=`#ifdef LIGHTMAP
...
#endif
`;a.l.IncludesShadersStore[y]||(a.l.IncludesShadersStore[y]=G);let V="pbrBlockGeometryInfo",H=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;a.l.IncludesShadersStore[V]||(a.l.IncludesShadersStore[V]=H);let x="pbrBlockReflectance",W=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;a.l.IncludesShadersStore[x]||(a.l.IncludesShadersStore[x]=W);let Y="pbrBlockDirectLighting",X=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;a.l.IncludesShadersStore[Y]||(a.l.IncludesShadersStore[Y]=X),n(76802);let k="pbrBlockFinalLitComponents",w=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;a.l.IncludesShadersStore[k]||(a.l.IncludesShadersStore[k]=w);let z="pbrBlockFinalUnlitComponents",K=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;a.l.IncludesShadersStore[z]||(a.l.IncludesShadersStore[z]=K);let Z="pbrBlockFinalColorComposition",q=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;a.l.IncludesShadersStore[Z]||(a.l.IncludesShadersStore[Z]=q),n(62975),n(86826),n(95291),n(8425),n(44950),n(79191);let J="pbrPixelShader",j=`#define PBR_FRAGMENT_SHADER
...
`;a.l.ShadersStore[J]||(a.l.ShadersStore[J]=j);let Q={name:J,shader:j}}}]);