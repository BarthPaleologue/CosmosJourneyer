...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["802"],{20003:function(e,i,t){t.r(i),t.d(i,{bumpFragment:()=>f});var o=t(68415);let a="bumpFragment",n=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;o.l.IncludesShadersStore[a]||(o.l.IncludesShadersStore[a]=n);let f={name:a,shader:n}},98846:function(e,i,t){t.r(i),t.d(i,{bumpFragmentFunctions:()=>f});var o=t(68415);t(23355);let a="bumpFragmentFunctions",n=`#if defined(BUMP)
...
#endif
`;o.l.IncludesShadersStore[a]||(o.l.IncludesShadersStore[a]=n);let f={name:a,shader:n}},38181:function(e,i,t){t.r(i),t.d(i,{bumpFragmentMainFunctions:()=>f});var o=t(68415);let a="bumpFragmentMainFunctions",n=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#ifdef OBJECTSPACE_NORMALMAP
...
#endif
`;o.l.IncludesShadersStore[a]||(o.l.IncludesShadersStore[a]=n);let f={name:a,shader:n}},84959:function(e,i,t){var o=t(68415);let a="clusteredLightingFunctions",n=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;o.l.IncludesShadersStore[a]||(o.l.IncludesShadersStore[a]=n)},71734:function(e,i,t){var o=t(68415);let a="decalFragment",n=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;o.l.IncludesShadersStore[a]||(o.l.IncludesShadersStore[a]=n)},66515:function(e,i,t){t.r(i),t.d(i,{lightFragment:()=>f});var o=t(68415);let a="lightFragment",n=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.l.IncludesShadersStore[a]||(o.l.IncludesShadersStore[a]=n);let f={name:a,shader:n}}}]);