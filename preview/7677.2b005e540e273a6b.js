...
return result;}
#endif
`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f);let l={name:t,shader:f}},17900(e,r,i){i.r(r),i.d(r,{backgroundPixelShaderWGSL:()=>a});var o=i(56863);i(31726),i(75185),i(82763),i(92412),i(59556),i(67342),i(92856),i(50221),i(63745),i(64470),i(3162);let t="intersectionFunctions",f=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;o.l.IncludesShadersStoreWGSL[t]||(o.l.IncludesShadersStoreWGSL[t]=f),i(19456),i(53148),i(44865),i(56044);let l="backgroundPixelShader",n=`#include<backgroundUboDeclaration>
...
`;o.l.ShadersStoreWGSL[l]||(o.l.ShadersStoreWGSL[l]=n);let a={name:l,shader:n}}}]);