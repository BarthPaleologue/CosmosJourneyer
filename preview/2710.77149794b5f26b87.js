"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["2710"],{53719:function(e,t,o){var a=o(38700);let n="hdrFilteringFunctions",i=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;a.l.IncludesShadersStore[n]||(a.l.IncludesShadersStore[n]=i)},73203:function(e,t,o){var a=o(38700);let n="importanceSampling",i=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;a.l.IncludesShadersStore[n]||(a.l.IncludesShadersStore[n]=i)},41867:function(e,t,o){var a=o(38700);let n="pbrBRDFFunctions",i=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;a.l.IncludesShadersStore[n]||(a.l.IncludesShadersStore[n]=i)},47205:function(e,t,o){o.r(t),o.d(t,{hdrFilteringPixelShader:()=>l});var a=o(38700);o(66207),o(73203),o(41867),o(53719);let n="hdrFilteringPixelShader",i=`#include<helperFunctions>
