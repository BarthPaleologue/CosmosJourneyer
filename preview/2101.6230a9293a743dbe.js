...
"use strict";(globalThis.webpackChunk_cosmos_journeyer_game=globalThis.webpackChunk_cosmos_journeyer_game||[]).push([["2101"],{49629(e,a,r){r.r(a),r.d(a,{bumpFragmentWGSL:()=>t});var i=r(17984);let n="bumpFragment",f=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},43308(e,a,r){r.r(a),r.d(a,{bumpFragmentFunctionsWGSL:()=>t});var i=r(17984);r(2977);let n="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;i.l.IncludesShadersStoreWGSL[n]||(i.l.IncludesShadersStoreWGSL[n]=f);let t={name:n,shader:f}},74599(e,a,r){r.r(a),r.d(a,{bumpFragmentMainFunctionsWGSL:()=>t});var i=r(17984);let n="bumpFragmentMainFunctions",f=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
...
#endif
`;i.l.IncludesShadersStoreWGSL[t]||(i.l.IncludesShadersStoreWGSL[t]=o),r(73023),r(84033),r(1488),r(97949),r(47720),r(11125),r(8990),r(87576),r(41662),r(19751),r(80040),r(2046),r(98811),r(98522),r(11308),r(64255),r(39467),r(74599),r(43308),r(51832),r(88452);let c="pbrBlockAlbedoOpacity",l=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
return outParams;}
#endif
`;i.l.IncludesShadersStoreWGSL[_]||(i.l.IncludesShadersStoreWGSL[_]=M),r(79009),r(13114),r(49629);let D="pbrBlockNormalFinal",F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[D]||(i.l.IncludesShadersStoreWGSL[D]=F),r(49574);let g="pbrBlockLightmapInit",h=`#ifdef LIGHTMAP
...
#endif
#endif
`;i.l.IncludesShadersStoreWGSL[P]||(i.l.IncludesShadersStoreWGSL[P]=b),r(84230);let U="pbrBlockReflectance",B=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
`;i.l.IncludesShadersStoreWGSL[y]||(i.l.IncludesShadersStoreWGSL[y]=x),r(33209);let G="pbrBlockFinalLitComponents",V=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
`;i.l.IncludesShadersStoreWGSL[Y]||(i.l.IncludesShadersStoreWGSL[Y]=k),r(15982),r(35285),r(3292),r(34082),r(4445),r(18966);let X="pbrPixelShader",w=`#define PBR_FRAGMENT_SHADER
