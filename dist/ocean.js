...
//#region Sliders
new Slider("oceanRadius", document.getElementById("oceanRadius"), 0, 20, 10, (val) => {
    ocean.settings.oceanRadius = 10 + val / 10;
});
new Slider("alphaModifier", document.getElementById("alphaModifier"), 0, 500, ocean.settings.alphaModifier * 100, (val) => {
