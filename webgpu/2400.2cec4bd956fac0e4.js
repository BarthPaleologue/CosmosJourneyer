"use strict";(globalThis.webpackChunkcosmos_journeyer=globalThis.webpackChunkcosmos_journeyer||[]).push([["2400"],{17269:function(e,t,o){var a=o(66755);let i="hdrFilteringFunctions",n=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;a.v.IncludesShadersStore[i]||(a.v.IncludesShadersStore[i]=n)},2339:function(e,t,o){var a=o(66755);let i="pbrBRDFFunctions",n=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;a.v.IncludesShadersStore[i]||(a.v.IncludesShadersStore[i]=n)},62918:function(e,t,o){var a=o(66755);let i="importanceSampling",n=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;a.v.IncludesShadersStore[i]||(a.v.IncludesShadersStore[i]=n)},77541:function(e,t,o){o.r(t),o.d(t,{iblDominantDirectionPixelShader:()=>l});var a=o(66755);o(95277),o(62918),o(2339),o(17269);let i="iblDominantDirectionPixelShader",n=`precision highp sampler2D;precision highp samplerCube;
...
lightDir/=float(NUM_SAMPLES);gl_FragColor=vec4(lightDir,1.0);}`;a.v.ShadersStore[i]||(a.v.ShadersStore[i]=n);let l={name:i,shader:n}}}]);