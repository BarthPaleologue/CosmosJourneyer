...
export class CreditsPanel {
    ...
    private createPanelHTML(): HTMLElement {
        ...
        const materialsCredits = [
            ...
            'Tire material from <a target="_blank" href="https://www.texturecan.com/details/445/">texturecan.com</a>, licensed under the Creative Commons CC0 1.0 Universal License.',
