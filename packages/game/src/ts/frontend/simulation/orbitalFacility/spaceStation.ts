...
import { EngineBay } from "@/frontend/presentation/assets/procedural/spaceStation/engineBay";
import { CylinderHabitat } from "@/frontend/presentation/assets/procedural/spaceStation/habitats/cylinder/cylinderHabitat";
import { HelixHabitat } from "@/frontend/presentation/assets/procedural/spaceStation/habitats/helix/helixHabitat";
import { RingHabitat } from "@/frontend/presentation/assets/procedural/spaceStation/habitats/ring/ringHabitat";
import { LandingBay } from "@/frontend/presentation/assets/procedural/spaceStation/landingBay/landingBay";
import { SolarSection } from "@/frontend/presentation/assets/procedural/spaceStation/solarSection";
import { TokamakSection } from "@/frontend/presentation/assets/procedural/spaceStation/tokamakSection";
import { UtilitySection } from "@/frontend/presentation/assets/procedural/spaceStation/utilitySection";
...
export class SpaceStation implements OrbitalFacilityBase<"spaceStation"> {
    ...
    private getSectionFromModel(model: StationSectionModel, assets: RenderingAssets): StationSection {
        switch (model.type) {
            case "engineBay":
    ...
    private generate(assets: RenderingAssets): void {
        for (const section of this.model.sections) {
            ...
            if (lastNode !== undefined) {
                this.placeNode(newSection.getTransform(), lastNode.getTransform());
            }
