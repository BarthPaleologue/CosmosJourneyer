...
import { type MissionNodeSerialized } from "@cosmos-journeyer/backend/missions/missionNodeSerialized";
import { type MissionNodeType } from "@cosmos-journeyer/backend/missions/missionNodeType";
