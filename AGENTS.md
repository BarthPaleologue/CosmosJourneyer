...
- Toolchain baseline: see root `package.json` engines for the current Node.js/pnpm versions; strict TypeScript across packages, strict linting via ESLint, formatting with Oxfmt.
