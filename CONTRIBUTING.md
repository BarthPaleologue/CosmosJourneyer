...
3. Create a new branch from the `main` branch:
    ...
    ```
4. Test your changes (`pnpm test:unit` and [end-to-end tests](/packages/playground/tests/Readme.md))
...
To make a change in an existing language, go to `packages/frontend/src/locales` and find the language you want to modify by its code.
...
Adding a new language altogether is quite straightforward as well. Simply go to the `packages/frontend/src/locales` folder and create a new folder with the language code you want to create.
